...
struct Route_
{
  ...
  using _primitives_type =
    rosidl_runtime_cpp::BoundedVector<autoware_auto_mapping_msgs::msg::MapPrimitive_<ContainerAllocator>, 100, typename ContainerAllocator::template rebind<autoware_auto_mapping_msgs::msg::MapPrimitive_<ContainerAllocator>>::other>;
  ...
  Type & set__primitives(
    const rosidl_runtime_cpp::BoundedVector<autoware_auto_mapping_msgs::msg::MapPrimitive_<ContainerAllocator>, 100, typename ContainerAllocator::template rebind<autoware_auto_mapping_msgs::msg::MapPrimitive_<ContainerAllocator>>::other> & _arg)
  {
