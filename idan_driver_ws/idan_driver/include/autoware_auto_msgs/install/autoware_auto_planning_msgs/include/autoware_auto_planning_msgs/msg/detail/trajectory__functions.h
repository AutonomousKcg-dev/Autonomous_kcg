...
#ifndef AUTOWARE_AUTO_PLANNING_MSGS__MSG__DETAIL__TRAJECTORY__FUNCTIONS_H_
#define AUTOWARE_AUTO_PLANNING_MSGS__MSG__DETAIL__TRAJECTORY__FUNCTIONS_H_
 ...
 * calls
 * autoware_auto_planning_msgs__msg__Trajectory__init().
...
/**
 * It calls
 * autoware_auto_planning_msgs__msg__Trajectory__fini()
 ...
 * autoware_auto_planning_msgs__msg__Trajectory__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_auto_planning_msgs__msg__Trajectory__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_AUTO_PLANNING_MSGS__MSG__DETAIL__TRAJECTORY__FUNCTIONS_H_
