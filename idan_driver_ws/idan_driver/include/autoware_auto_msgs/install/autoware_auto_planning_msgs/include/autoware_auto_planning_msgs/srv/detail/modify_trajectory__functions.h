...
#ifndef AUTOWARE_AUTO_PLANNING_MSGS__SRV__DETAIL__MODIFY_TRAJECTORY__FUNCTIONS_H_
#define AUTOWARE_AUTO_PLANNING_MSGS__SRV__DETAIL__MODIFY_TRAJECTORY__FUNCTIONS_H_
...
/// Initialize srv/ModifyTrajectory message.
/**
...
/// Finalize srv/ModifyTrajectory message.
/**
...
/// Create srv/ModifyTrajectory message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__init().
...
/// Destroy srv/ModifyTrajectory message.
/**
 * It calls
 * autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__fini()
...
/// Initialize array of srv/ModifyTrajectory messages.
/**
...
/// Finalize array of srv/ModifyTrajectory messages.
/**
 * It calls
 * autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__fini()
...
/// Create array of srv/ModifyTrajectory messages.
/**
 * It allocates the memory for the array and calls
 * autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ModifyTrajectory messages.
/**
 * It calls
 * autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * autoware_auto_planning_msgs__srv__ModifyTrajectory_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autoware_auto_planning_msgs
...
/**
 * It calls
 * autoware_auto_planning_msgs__srv__ModifyTrajectory_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_autoware_auto_planning_msgs
...
/**
 * It allocates the memory for the array and calls
 * autoware_auto_planning_msgs__srv__ModifyTrajectory_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autoware_auto_planning_msgs
...
/**
 * It calls
 * autoware_auto_planning_msgs__srv__ModifyTrajectory_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AUTOWARE_AUTO_PLANNING_MSGS__SRV__DETAIL__MODIFY_TRAJECTORY__FUNCTIONS_H_
