...
{
  autoware_auto_planning_msgs__srv__ModifyTrajectory_Request * msg = (autoware_auto_planning_msgs__srv__ModifyTrajectory_Request *)malloc(sizeof(autoware_auto_planning_msgs__srv__ModifyTrajectory_Request));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__Sequence__init(autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_planning_msgs__srv__ModifyTrajectory_Request *)calloc(size, sizeof(autoware_auto_planning_msgs__srv__ModifyTrajectory_Request));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__Sequence * array = (autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__Sequence *)malloc(sizeof(autoware_auto_planning_msgs__srv__ModifyTrajectory_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  autoware_auto_planning_msgs__srv__ModifyTrajectory_Response * msg = (autoware_auto_planning_msgs__srv__ModifyTrajectory_Response *)malloc(sizeof(autoware_auto_planning_msgs__srv__ModifyTrajectory_Response));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_planning_msgs__srv__ModifyTrajectory_Response__Sequence__init(autoware_auto_planning_msgs__srv__ModifyTrajectory_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_planning_msgs__srv__ModifyTrajectory_Response *)calloc(size, sizeof(autoware_auto_planning_msgs__srv__ModifyTrajectory_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  autoware_auto_planning_msgs__srv__ModifyTrajectory_Response__Sequence * array = (autoware_auto_planning_msgs__srv__ModifyTrajectory_Response__Sequence *)malloc(sizeof(autoware_auto_planning_msgs__srv__ModifyTrajectory_Response__Sequence));
  if (!array) {
    return NULL;
  }
