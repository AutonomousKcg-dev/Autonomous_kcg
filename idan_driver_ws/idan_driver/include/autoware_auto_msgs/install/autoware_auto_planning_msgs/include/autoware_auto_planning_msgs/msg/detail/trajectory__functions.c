...
{
  autoware_auto_planning_msgs__msg__Trajectory * msg = (autoware_auto_planning_msgs__msg__Trajectory *)malloc(sizeof(autoware_auto_planning_msgs__msg__Trajectory));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_planning_msgs__msg__Trajectory__Sequence__init(autoware_auto_planning_msgs__msg__Trajectory__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_planning_msgs__msg__Trajectory *)calloc(size, sizeof(autoware_auto_planning_msgs__msg__Trajectory));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_planning_msgs__msg__Trajectory__Sequence * array = (autoware_auto_planning_msgs__msg__Trajectory__Sequence *)malloc(sizeof(autoware_auto_planning_msgs__msg__Trajectory__Sequence));
  if (!array) {
    return NULL;
  }
