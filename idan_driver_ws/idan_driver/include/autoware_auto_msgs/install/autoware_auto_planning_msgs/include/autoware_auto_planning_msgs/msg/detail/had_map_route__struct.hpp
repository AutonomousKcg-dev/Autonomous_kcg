...
struct HADMapRoute_
{
  ...
  using _segments_type =
    std::vector<autoware_auto_mapping_msgs::msg::HADMapSegment_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_mapping_msgs::msg::HADMapSegment_<ContainerAllocator>>::other>;
  ...
  Type & set__segments(
    const std::vector<autoware_auto_mapping_msgs::msg::HADMapSegment_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_mapping_msgs::msg::HADMapSegment_<ContainerAllocator>>::other> & _arg)
  {
    this->segments = _arg;
    return *this;
  }
