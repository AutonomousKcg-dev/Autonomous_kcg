...
#include <stddef.h>
#include "autoware_auto_vehicle_msgs/msg/detail/engage__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_auto_vehicle_msgs__msg__Engage__init(message_memory);
}

void Engage__rosidl_typesupport_introspection_c__Engage_fini_function(void * message_memory)
{
  autoware_auto_vehicle_msgs__msg__Engage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Engage__rosidl_typesupport_introspection_c__Engage_message_member_array[2] = {
  {
    ...
    offsetof(autoware_auto_vehicle_msgs__msg__Engage, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_vehicle_msgs__msg__Engage, engage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Engage__rosidl_typesupport_introspection_c__Engage_message_members = {
  ...
  "Engage",  // message name
  2,  // number of fields
  sizeof(autoware_auto_vehicle_msgs__msg__Engage),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_vehicle_msgs, msg, Engage)() {
