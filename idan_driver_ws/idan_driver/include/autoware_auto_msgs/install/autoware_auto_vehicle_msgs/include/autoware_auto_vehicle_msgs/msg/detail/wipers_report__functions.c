...
autoware_auto_vehicle_msgs__msg__WipersReport__init(autoware_auto_vehicle_msgs__msg__WipersReport * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    autoware_auto_vehicle_msgs__msg__WipersReport__fini(msg);
    return false;
  }
  // report
  msg->report = 0;
...
{
  autoware_auto_vehicle_msgs__msg__WipersReport * msg = (autoware_auto_vehicle_msgs__msg__WipersReport *)malloc(sizeof(autoware_auto_vehicle_msgs__msg__WipersReport));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autoware_auto_vehicle_msgs__msg__WipersReport));
  bool success = autoware_auto_vehicle_msgs__msg__WipersReport__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
autoware_auto_vehicle_msgs__msg__WipersReport__Sequence__init(autoware_auto_vehicle_msgs__msg__WipersReport__Sequence * array, size_t size)
{
  ...
  autoware_auto_vehicle_msgs__msg__WipersReport * data = NULL;
  if (size) {
    data = (autoware_auto_vehicle_msgs__msg__WipersReport *)calloc(size, sizeof(autoware_auto_vehicle_msgs__msg__WipersReport));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autoware_auto_vehicle_msgs__msg__WipersReport__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        autoware_auto_vehicle_msgs__msg__WipersReport__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
autoware_auto_vehicle_msgs__msg__WipersReport__Sequence__fini(autoware_auto_vehicle_msgs__msg__WipersReport__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      autoware_auto_vehicle_msgs__msg__WipersReport__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  autoware_auto_vehicle_msgs__msg__WipersReport__Sequence * array = (autoware_auto_vehicle_msgs__msg__WipersReport__Sequence *)malloc(sizeof(autoware_auto_vehicle_msgs__msg__WipersReport__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = autoware_auto_vehicle_msgs__msg__WipersReport__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    autoware_auto_vehicle_msgs__msg__WipersReport__Sequence__fini(array);
  }
  free(array);
}
