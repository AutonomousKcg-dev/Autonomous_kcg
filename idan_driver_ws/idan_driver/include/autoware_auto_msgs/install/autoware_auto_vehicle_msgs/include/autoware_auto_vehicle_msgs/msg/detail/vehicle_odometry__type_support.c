...
#include <stddef.h>
#include "autoware_auto_vehicle_msgs/msg/detail/vehicle_odometry__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_auto_vehicle_msgs__msg__VehicleOdometry__init(message_memory);
}

void VehicleOdometry__rosidl_typesupport_introspection_c__VehicleOdometry_fini_function(void * message_memory)
{
  autoware_auto_vehicle_msgs__msg__VehicleOdometry__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember VehicleOdometry__rosidl_typesupport_introspection_c__VehicleOdometry_message_member_array[4] = {
  {
    ...
    offsetof(autoware_auto_vehicle_msgs__msg__VehicleOdometry, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_vehicle_msgs__msg__VehicleOdometry, velocity_mps),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_vehicle_msgs__msg__VehicleOdometry, front_wheel_angle_rad),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_vehicle_msgs__msg__VehicleOdometry, rear_wheel_angle_rad),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleOdometry__rosidl_typesupport_introspection_c__VehicleOdometry_message_members = {
  ...
  4,  // number of fields
  sizeof(autoware_auto_vehicle_msgs__msg__VehicleOdometry),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_vehicle_msgs, msg, VehicleOdometry)() {
