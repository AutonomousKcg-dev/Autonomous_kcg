...
bool autoware_auto_geometry_msgs__msg__relative_position_with_covariance_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_geometry_msgs.msg._relative_position_with_covariance_stamped.RelativePositionWithCovarianceStamped", full_classname_dest, 112) == 0);
  }
  autoware_auto_geometry_msgs__msg__RelativePositionWithCovarianceStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RelativePositionWithCovarianceStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_geometry_msgs.msg._relative_position_with_covariance_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RelativePositionWithCovarianceStamped");
