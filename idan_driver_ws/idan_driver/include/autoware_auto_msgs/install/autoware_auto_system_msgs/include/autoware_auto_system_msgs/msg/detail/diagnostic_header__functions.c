...
{
  autoware_auto_system_msgs__msg__DiagnosticHeader * msg = (autoware_auto_system_msgs__msg__DiagnosticHeader *)malloc(sizeof(autoware_auto_system_msgs__msg__DiagnosticHeader));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_system_msgs__msg__DiagnosticHeader__Sequence__init(autoware_auto_system_msgs__msg__DiagnosticHeader__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_system_msgs__msg__DiagnosticHeader *)calloc(size, sizeof(autoware_auto_system_msgs__msg__DiagnosticHeader));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_system_msgs__msg__DiagnosticHeader__Sequence * array = (autoware_auto_system_msgs__msg__DiagnosticHeader__Sequence *)malloc(sizeof(autoware_auto_system_msgs__msg__DiagnosticHeader__Sequence));
  if (!array) {
    return NULL;
  }
