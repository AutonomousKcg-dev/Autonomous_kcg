...
#ifndef AUTOWARE_AUTO_SYSTEM_MSGS__MSG__DETAIL__DRIVING_CAPABILITY__FUNCTIONS_H_
#define AUTOWARE_AUTO_SYSTEM_MSGS__MSG__DETAIL__DRIVING_CAPABILITY__FUNCTIONS_H_
 ...
 * calls
 * autoware_auto_system_msgs__msg__DrivingCapability__init().
...
/**
 * It calls
 * autoware_auto_system_msgs__msg__DrivingCapability__fini()
 ...
 * autoware_auto_system_msgs__msg__DrivingCapability__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_auto_system_msgs__msg__DrivingCapability__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_AUTO_SYSTEM_MSGS__MSG__DETAIL__DRIVING_CAPABILITY__FUNCTIONS_H_
