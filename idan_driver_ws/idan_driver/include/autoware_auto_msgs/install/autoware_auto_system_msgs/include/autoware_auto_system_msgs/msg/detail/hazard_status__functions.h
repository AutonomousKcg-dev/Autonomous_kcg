...
#ifndef AUTOWARE_AUTO_SYSTEM_MSGS__MSG__DETAIL__HAZARD_STATUS__FUNCTIONS_H_
#define AUTOWARE_AUTO_SYSTEM_MSGS__MSG__DETAIL__HAZARD_STATUS__FUNCTIONS_H_
 ...
 * calls
 * autoware_auto_system_msgs__msg__HazardStatus__init().
...
/**
 * It calls
 * autoware_auto_system_msgs__msg__HazardStatus__fini()
 ...
 * autoware_auto_system_msgs__msg__HazardStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_auto_system_msgs__msg__HazardStatus__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_AUTO_SYSTEM_MSGS__MSG__DETAIL__HAZARD_STATUS__FUNCTIONS_H_
