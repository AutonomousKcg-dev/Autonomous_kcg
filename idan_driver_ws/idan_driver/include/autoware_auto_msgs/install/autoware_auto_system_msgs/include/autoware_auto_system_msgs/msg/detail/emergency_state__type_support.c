...
#include <stddef.h>
#include "autoware_auto_system_msgs/msg/detail/emergency_state__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_auto_system_msgs__msg__EmergencyState__init(message_memory);
}

void EmergencyState__rosidl_typesupport_introspection_c__EmergencyState_fini_function(void * message_memory)
{
  autoware_auto_system_msgs__msg__EmergencyState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember EmergencyState__rosidl_typesupport_introspection_c__EmergencyState_message_member_array[2] = {
  {
    "stamp",  // name
    ...
    offsetof(autoware_auto_system_msgs__msg__EmergencyState, stamp),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_system_msgs__msg__EmergencyState, state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers EmergencyState__rosidl_typesupport_introspection_c__EmergencyState_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_auto_system_msgs__msg__EmergencyState),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_system_msgs, msg, EmergencyState)() {
  EmergencyState__rosidl_typesupport_introspection_c__EmergencyState_message_member_array[0].members_ =
