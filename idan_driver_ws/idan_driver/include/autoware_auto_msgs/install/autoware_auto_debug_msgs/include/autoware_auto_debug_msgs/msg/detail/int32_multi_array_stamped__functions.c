...
{
  autoware_auto_debug_msgs__msg__Int32MultiArrayStamped * msg = (autoware_auto_debug_msgs__msg__Int32MultiArrayStamped *)malloc(sizeof(autoware_auto_debug_msgs__msg__Int32MultiArrayStamped));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__Int32MultiArrayStamped__Sequence__init(autoware_auto_debug_msgs__msg__Int32MultiArrayStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_debug_msgs__msg__Int32MultiArrayStamped *)calloc(size, sizeof(autoware_auto_debug_msgs__msg__Int32MultiArrayStamped));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_debug_msgs__msg__Int32MultiArrayStamped__Sequence * array = (autoware_auto_debug_msgs__msg__Int32MultiArrayStamped__Sequence *)malloc(sizeof(autoware_auto_debug_msgs__msg__Int32MultiArrayStamped__Sequence));
  if (!array) {
    return NULL;
  }
