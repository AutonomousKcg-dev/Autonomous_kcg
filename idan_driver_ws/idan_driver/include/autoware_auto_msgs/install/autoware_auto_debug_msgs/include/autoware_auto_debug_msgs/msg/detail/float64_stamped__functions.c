...
{
  autoware_auto_debug_msgs__msg__Float64Stamped * msg = (autoware_auto_debug_msgs__msg__Float64Stamped *)malloc(sizeof(autoware_auto_debug_msgs__msg__Float64Stamped));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__Float64Stamped__Sequence__init(autoware_auto_debug_msgs__msg__Float64Stamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_debug_msgs__msg__Float64Stamped *)calloc(size, sizeof(autoware_auto_debug_msgs__msg__Float64Stamped));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_debug_msgs__msg__Float64Stamped__Sequence * array = (autoware_auto_debug_msgs__msg__Float64Stamped__Sequence *)malloc(sizeof(autoware_auto_debug_msgs__msg__Float64Stamped__Sequence));
  if (!array) {
    return NULL;
  }
