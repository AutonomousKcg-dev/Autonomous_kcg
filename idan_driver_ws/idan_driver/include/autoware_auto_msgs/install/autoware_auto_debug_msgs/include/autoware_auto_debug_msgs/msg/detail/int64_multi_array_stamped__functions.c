...
{
  autoware_auto_debug_msgs__msg__Int64MultiArrayStamped * msg = (autoware_auto_debug_msgs__msg__Int64MultiArrayStamped *)malloc(sizeof(autoware_auto_debug_msgs__msg__Int64MultiArrayStamped));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__Int64MultiArrayStamped__Sequence__init(autoware_auto_debug_msgs__msg__Int64MultiArrayStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_debug_msgs__msg__Int64MultiArrayStamped *)calloc(size, sizeof(autoware_auto_debug_msgs__msg__Int64MultiArrayStamped));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_debug_msgs__msg__Int64MultiArrayStamped__Sequence * array = (autoware_auto_debug_msgs__msg__Int64MultiArrayStamped__Sequence *)malloc(sizeof(autoware_auto_debug_msgs__msg__Int64MultiArrayStamped__Sequence));
  if (!array) {
    return NULL;
  }
