...
{
  autoware_auto_mapping_msgs__msg__HADMapBin * msg = (autoware_auto_mapping_msgs__msg__HADMapBin *)malloc(sizeof(autoware_auto_mapping_msgs__msg__HADMapBin));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_mapping_msgs__msg__HADMapBin__Sequence__init(autoware_auto_mapping_msgs__msg__HADMapBin__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_mapping_msgs__msg__HADMapBin *)calloc(size, sizeof(autoware_auto_mapping_msgs__msg__HADMapBin));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_mapping_msgs__msg__HADMapBin__Sequence * array = (autoware_auto_mapping_msgs__msg__HADMapBin__Sequence *)malloc(sizeof(autoware_auto_mapping_msgs__msg__HADMapBin__Sequence));
  if (!array) {
    return NULL;
  }
