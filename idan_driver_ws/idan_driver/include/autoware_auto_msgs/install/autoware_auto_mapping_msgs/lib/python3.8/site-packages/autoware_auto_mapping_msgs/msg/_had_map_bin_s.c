...
bool autoware_auto_mapping_msgs__msg__had_map_bin__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_mapping_msgs.msg._had_map_bin.HADMapBin", full_classname_dest, 53) == 0);
  }
  autoware_auto_mapping_msgs__msg__HADMapBin * ros_message = _ros_message;
  {  // header
  ...
  {  // map_format
    PyObject * field = PyObject_GetAttrString(_pymsg, "map_format");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->map_format = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // format_version
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * autoware_auto_mapping_msgs__msg__had_map_bin__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of HADMapBin */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_mapping_msgs.msg._had_map_bin");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HADMapBin");
  ...
  autoware_auto_mapping_msgs__msg__HADMapBin * ros_message = (autoware_auto_mapping_msgs__msg__HADMapBin *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // map_format
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->map_format);
    {
      int rc = PyObject_SetAttrString(_pymessage, "map_format", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
