...
class DetectedObject(metaclass=Metaclass_DetectedObject):
    ...
    _fields_and_field_types = {
        ...
        'kinematics': 'autoware_auto_perception_msgs/DetectedObjectKinematics',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['autoware_auto_perception_msgs', 'msg'], 'DetectedObjectKinematics'),  # noqa: E501
