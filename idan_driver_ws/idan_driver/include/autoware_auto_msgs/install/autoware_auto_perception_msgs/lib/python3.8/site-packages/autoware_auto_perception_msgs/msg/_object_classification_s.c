...
bool autoware_auto_perception_msgs__msg__object_classification__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_perception_msgs.msg._object_classification.ObjectClassification", full_classname_dest, 77) == 0);
  }
  autoware_auto_perception_msgs__msg__ObjectClassification * ros_message = _ros_message;
  {  // classification
...
{
  /* NOTE(esteve): Call constructor of ObjectClassification */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_perception_msgs.msg._object_classification");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectClassification");
