...
class DetectedObjects(metaclass=Metaclass_DetectedObjects):
    ...
    _fields_and_field_types = {
        ...
        'objects': 'sequence<autoware_auto_perception_msgs/DetectedObject>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autoware_auto_perception_msgs', 'msg'], 'DetectedObject')),  # noqa: E501
    )
