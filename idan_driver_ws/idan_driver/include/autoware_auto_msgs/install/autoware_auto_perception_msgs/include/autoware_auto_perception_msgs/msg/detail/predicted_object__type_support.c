...
size_t PredictedObject__rosidl_typesupport_introspection_c__size_function__Shape__shape(
  const void * untyped_member)
{
...
const void * PredictedObject__rosidl_typesupport_introspection_c__get_const_function__Shape__shape(
  const void * untyped_member, size_t index)
{
  const autoware_auto_perception_msgs__msg__Shape__Sequence * member =
    (const autoware_auto_perception_msgs__msg__Shape__Sequence *)(untyped_member);
...
void * PredictedObject__rosidl_typesupport_introspection_c__get_function__Shape__shape(
  void * untyped_member, size_t index)
{
...
bool PredictedObject__rosidl_typesupport_introspection_c__resize_function__Shape__shape(
  void * untyped_member, size_t size)
{
  autoware_auto_perception_msgs__msg__Shape__Sequence * member =
    (autoware_auto_perception_msgs__msg__Shape__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember PredictedObject__rosidl_typesupport_introspection_c__PredictedObject_message_member_array[6] = {
  {
    "uuid",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    PredictedObject__rosidl_typesupport_introspection_c__size_function__Shape__shape,  // size() function pointer
    PredictedObject__rosidl_typesupport_introspection_c__get_const_function__Shape__shape,  // get_const(index) function pointer
    PredictedObject__rosidl_typesupport_introspection_c__get_function__Shape__shape,  // get(index) function pointer
    PredictedObject__rosidl_typesupport_introspection_c__resize_function__Shape__shape  // resize(index) function pointer
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_perception_msgs, msg, PredictedObject)() {
  ...
  PredictedObject__rosidl_typesupport_introspection_c__PredictedObject_message_member_array[5].members_ =
