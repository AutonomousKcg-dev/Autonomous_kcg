...
struct PredictedPath_
{
  ...
  using _path_type =
    rosidl_runtime_cpp::BoundedVector<geometry_msgs::msg::Pose_<ContainerAllocator>, 100, typename ContainerAllocator::template rebind<geometry_msgs::msg::Pose_<ContainerAllocator>>::other>;
  _path_type path;
  ...
  Type & set__path(
    const rosidl_runtime_cpp::BoundedVector<geometry_msgs::msg::Pose_<ContainerAllocator>, 100, typename ContainerAllocator::template rebind<geometry_msgs::msg::Pose_<ContainerAllocator>>::other> & _arg)
  {
    this->path = _arg;
    return *this;
  }
