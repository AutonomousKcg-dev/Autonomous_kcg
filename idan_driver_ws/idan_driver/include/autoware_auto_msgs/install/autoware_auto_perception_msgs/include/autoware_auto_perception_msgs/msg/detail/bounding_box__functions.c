...
{
  autoware_auto_perception_msgs__msg__BoundingBox * msg = (autoware_auto_perception_msgs__msg__BoundingBox *)malloc(sizeof(autoware_auto_perception_msgs__msg__BoundingBox));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_perception_msgs__msg__BoundingBox__Sequence__init(autoware_auto_perception_msgs__msg__BoundingBox__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_perception_msgs__msg__BoundingBox *)calloc(size, sizeof(autoware_auto_perception_msgs__msg__BoundingBox));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_perception_msgs__msg__BoundingBox__Sequence * array = (autoware_auto_perception_msgs__msg__BoundingBox__Sequence *)malloc(sizeof(autoware_auto_perception_msgs__msg__BoundingBox__Sequence));
  if (!array) {
    return NULL;
  }
