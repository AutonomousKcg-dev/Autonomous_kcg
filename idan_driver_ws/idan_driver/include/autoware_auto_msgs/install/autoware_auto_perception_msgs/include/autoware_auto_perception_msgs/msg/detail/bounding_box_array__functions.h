...
#ifndef AUTOWARE_AUTO_PERCEPTION_MSGS__MSG__DETAIL__BOUNDING_BOX_ARRAY__FUNCTIONS_H_
#define AUTOWARE_AUTO_PERCEPTION_MSGS__MSG__DETAIL__BOUNDING_BOX_ARRAY__FUNCTIONS_H_
 ...
 * calls
 * autoware_auto_perception_msgs__msg__BoundingBoxArray__init().
...
/**
 * It calls
 * autoware_auto_perception_msgs__msg__BoundingBoxArray__fini()
 ...
 * autoware_auto_perception_msgs__msg__BoundingBoxArray__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_auto_perception_msgs__msg__BoundingBoxArray__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_AUTO_PERCEPTION_MSGS__MSG__DETAIL__BOUNDING_BOX_ARRAY__FUNCTIONS_H_
