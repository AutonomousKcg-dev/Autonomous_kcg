...
{
  autoware_auto_perception_msgs__msg__PointClusters * msg = (autoware_auto_perception_msgs__msg__PointClusters *)malloc(sizeof(autoware_auto_perception_msgs__msg__PointClusters));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_perception_msgs__msg__PointClusters__Sequence__init(autoware_auto_perception_msgs__msg__PointClusters__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_perception_msgs__msg__PointClusters *)calloc(size, sizeof(autoware_auto_perception_msgs__msg__PointClusters));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_perception_msgs__msg__PointClusters__Sequence * array = (autoware_auto_perception_msgs__msg__PointClusters__Sequence *)malloc(sizeof(autoware_auto_perception_msgs__msg__PointClusters__Sequence));
  if (!array) {
    return NULL;
  }
