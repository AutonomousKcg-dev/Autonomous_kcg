...
#ifndef AUTOWARE_AUTO_PERCEPTION_MSGS__MSG__DETAIL__TRACKED_OBJECT__FUNCTIONS_H_
#define AUTOWARE_AUTO_PERCEPTION_MSGS__MSG__DETAIL__TRACKED_OBJECT__FUNCTIONS_H_
 ...
 * calls
 * autoware_auto_perception_msgs__msg__TrackedObject__init().
...
/**
 * It calls
 * autoware_auto_perception_msgs__msg__TrackedObject__fini()
 ...
 * autoware_auto_perception_msgs__msg__TrackedObject__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_auto_perception_msgs__msg__TrackedObject__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_AUTO_PERCEPTION_MSGS__MSG__DETAIL__TRACKED_OBJECT__FUNCTIONS_H_
