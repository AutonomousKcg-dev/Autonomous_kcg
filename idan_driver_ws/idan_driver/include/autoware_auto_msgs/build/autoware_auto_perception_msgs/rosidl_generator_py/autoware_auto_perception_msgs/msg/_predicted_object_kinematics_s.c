...
bool autoware_auto_perception_msgs__msg__predicted_object_kinematics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // initial_pose
    ...
    if (!geometry_msgs__msg__pose_with_covariance__convert_from_py(field, &ros_message->initial_pose)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // initial_twist
    PyObject * field = PyObject_GetAttrString(_pymsg, "initial_twist");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__twist_with_covariance__convert_from_py(field, &ros_message->initial_twist)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // initial_acceleration
    PyObject * field = PyObject_GetAttrString(_pymsg, "initial_acceleration");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__accel_with_covariance__convert_from_py(field, &ros_message->initial_acceleration)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * autoware_auto_perception_msgs__msg__predicted_object_kinematics__convert_to_py(void * raw_ros_message)
{
  ...
  {  // initial_pose
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose_with_covariance__convert_to_py(&ros_message->initial_pose);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // initial_twist
    PyObject * field = NULL;
    field = geometry_msgs__msg__twist_with_covariance__convert_to_py(&ros_message->initial_twist);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "initial_twist", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // initial_acceleration
    PyObject * field = NULL;
    field = geometry_msgs__msg__accel_with_covariance__convert_to_py(&ros_message->initial_acceleration);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "initial_acceleration", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
