...
struct TrackedObjects_
{
  ...
  _header_type header;
  using _objects_type =
    std::vector<autoware_auto_perception_msgs::msg::TrackedObject_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::TrackedObject_<ContainerAllocator>>::other>;
  ...
  Type & set__objects(
    const std::vector<autoware_auto_perception_msgs::msg::TrackedObject_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::TrackedObject_<ContainerAllocator>>::other> & _arg)
  {
    this->objects = _arg;
    return *this;
  }
