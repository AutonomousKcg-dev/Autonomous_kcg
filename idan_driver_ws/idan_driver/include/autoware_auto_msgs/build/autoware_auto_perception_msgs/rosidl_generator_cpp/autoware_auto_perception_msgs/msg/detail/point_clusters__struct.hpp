...
struct PointClusters_
{
  ...
  _header_type header;
  using _points_type =
    std::vector<autoware_auto_perception_msgs::msg::PointXYZIF_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::PointXYZIF_<ContainerAllocator>>::other>;
  _points_type points;
  ...
  Type & set__points(
    const std::vector<autoware_auto_perception_msgs::msg::PointXYZIF_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::PointXYZIF_<ContainerAllocator>>::other> & _arg)
  {
    this->points = _arg;
    return *this;
  }
