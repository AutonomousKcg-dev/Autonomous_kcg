...
struct BoundingBoxArray_
{
  ...
  _header_type header;
  using _boxes_type =
    rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::BoundingBox_<ContainerAllocator>, 256, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::BoundingBox_<ContainerAllocator>>::other>;
  _boxes_type boxes;
  ...
  Type & set__boxes(
    const rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::BoundingBox_<ContainerAllocator>, 256, typename ContainerAllocator::template rebind<autoware_auto_perception_msgs::msg::BoundingBox_<ContainerAllocator>>::other> & _arg)
  {
    this->boxes = _arg;
    return *this;
  }
