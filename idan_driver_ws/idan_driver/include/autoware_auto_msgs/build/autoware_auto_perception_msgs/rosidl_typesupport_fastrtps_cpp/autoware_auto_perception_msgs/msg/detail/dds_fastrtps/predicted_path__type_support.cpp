...
#include "autoware_auto_perception_msgs/msg/detail/predicted_path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_perception_msgs::msg::PredictedPath & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_perception_msgs::msg::PredictedPath & ros_message)
{
  // Member: path
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::PredictedPath *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_perception_msgs::msg::PredictedPath *>(
    untyped_ros_message);
...
{
  return max_serialized_size_PredictedPath(full_bounded, 0);
}
...
{
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_PredictedPath__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_perception_msgs, msg, PredictedPath)() {
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_PredictedPath__handle;
}
