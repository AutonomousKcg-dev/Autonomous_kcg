...
#include "autoware_auto_perception_msgs/msg/detail/bounding_box_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_auto_perception_msgs::msg::BoundingBox &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const autoware_auto_perception_msgs::msg::BoundingBoxArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_perception_msgs::msg::BoundingBoxArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BoundingBox(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::BoundingBoxArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_perception_msgs::msg::BoundingBoxArray *>(
    untyped_ros_message);
...
{
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_BoundingBoxArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_perception_msgs, msg, BoundingBoxArray)() {
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_BoundingBoxArray__handle;
}
