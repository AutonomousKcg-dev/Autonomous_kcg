...
#include "autoware_auto_perception_msgs/msg/detail/detected_objects__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_perception_msgs::msg::DetectedObjects & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_perception_msgs::msg::DetectedObjects & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::DetectedObjects *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_perception_msgs::msg::DetectedObjects *>(
    untyped_ros_message);
...
{
  return max_serialized_size_DetectedObjects(full_bounded, 0);
}
...
{
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjects__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_perception_msgs, msg, DetectedObjects)() {
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_DetectedObjects__handle;
}
