...
#include "autoware_auto_perception_msgs/msg/detail/classified_roi__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_perception_msgs::msg::ClassifiedRoi & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_perception_msgs::msg::ClassifiedRoi & ros_message)
{
  // Member: classifications
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::ClassifiedRoi *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_perception_msgs::msg::ClassifiedRoi *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ClassifiedRoi__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::ClassifiedRoi *>(
...
static size_t _ClassifiedRoi__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ClassifiedRoi(full_bounded, 0);
}

static message_type_support_callbacks_t _ClassifiedRoi__callbacks = {
...
static rosidl_message_type_support_t _ClassifiedRoi__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ClassifiedRoi__callbacks,
...
{
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_ClassifiedRoi__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_perception_msgs, msg, ClassifiedRoi)() {
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_ClassifiedRoi__handle;
}
