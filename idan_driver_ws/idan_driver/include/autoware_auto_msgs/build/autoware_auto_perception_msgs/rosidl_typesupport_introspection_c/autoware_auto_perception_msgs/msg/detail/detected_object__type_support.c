...
size_t DetectedObject__rosidl_typesupport_introspection_c__size_function__ObjectClassification__classification(
...
const void * DetectedObject__rosidl_typesupport_introspection_c__get_const_function__ObjectClassification__classification(
...
void * DetectedObject__rosidl_typesupport_introspection_c__get_function__ObjectClassification__classification(
...
bool DetectedObject__rosidl_typesupport_introspection_c__resize_function__ObjectClassification__classification(
...
static rosidl_typesupport_introspection_c__MessageMember DetectedObject__rosidl_typesupport_introspection_c__DetectedObject_message_member_array[4] = {
  {
  ...
  },
  {
    ...
    NULL,  // default value
    DetectedObject__rosidl_typesupport_introspection_c__size_function__ObjectClassification__classification,  // size() function pointer
    DetectedObject__rosidl_typesupport_introspection_c__get_const_function__ObjectClassification__classification,  // get_const(index) function pointer
    DetectedObject__rosidl_typesupport_introspection_c__get_function__ObjectClassification__classification,  // get(index) function pointer
    DetectedObject__rosidl_typesupport_introspection_c__resize_function__ObjectClassification__classification  // resize(index) function pointer
  },
  {
    "kinematics",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_perception_msgs, msg, DetectedObject)() {
  ...
  DetectedObject__rosidl_typesupport_introspection_c__DetectedObject_message_member_array[3].members_ =
