...
size_t TrackedObject__rosidl_typesupport_introspection_c__size_function__ObjectClassification__classification(
...
const void * TrackedObject__rosidl_typesupport_introspection_c__get_const_function__ObjectClassification__classification(
...
void * TrackedObject__rosidl_typesupport_introspection_c__get_function__ObjectClassification__classification(
...
bool TrackedObject__rosidl_typesupport_introspection_c__resize_function__ObjectClassification__classification(
...
size_t TrackedObject__rosidl_typesupport_introspection_c__size_function__Shape__shape(
  const void * untyped_member)
{
...
const void * TrackedObject__rosidl_typesupport_introspection_c__get_const_function__Shape__shape(
  const void * untyped_member, size_t index)
{
  const autoware_auto_perception_msgs__msg__Shape__Sequence * member =
    (const autoware_auto_perception_msgs__msg__Shape__Sequence *)(untyped_member);
...
void * TrackedObject__rosidl_typesupport_introspection_c__get_function__Shape__shape(
  void * untyped_member, size_t index)
{
...
bool TrackedObject__rosidl_typesupport_introspection_c__resize_function__Shape__shape(
  void * untyped_member, size_t size)
{
  autoware_auto_perception_msgs__msg__Shape__Sequence * member =
    (autoware_auto_perception_msgs__msg__Shape__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember TrackedObject__rosidl_typesupport_introspection_c__TrackedObject_message_member_array[6] = {
  {
    "uuid",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    TrackedObject__rosidl_typesupport_introspection_c__size_function__ObjectClassification__classification,  // size() function pointer
    TrackedObject__rosidl_typesupport_introspection_c__get_const_function__ObjectClassification__classification,  // get_const(index) function pointer
    TrackedObject__rosidl_typesupport_introspection_c__get_function__ObjectClassification__classification,  // get(index) function pointer
    TrackedObject__rosidl_typesupport_introspection_c__resize_function__ObjectClassification__classification  // resize(index) function pointer
  },
  {
    "kinematics",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
  ...
  },
  {
    ...
    NULL,  // default value
    TrackedObject__rosidl_typesupport_introspection_c__size_function__Shape__shape,  // size() function pointer
    TrackedObject__rosidl_typesupport_introspection_c__get_const_function__Shape__shape,  // get_const(index) function pointer
    TrackedObject__rosidl_typesupport_introspection_c__get_function__Shape__shape,  // get(index) function pointer
    TrackedObject__rosidl_typesupport_introspection_c__resize_function__Shape__shape  // resize(index) function pointer
  }
};
