...
{
  autoware_auto_perception_msgs__msg__TrackedObjectKinematics * msg = (autoware_auto_perception_msgs__msg__TrackedObjectKinematics *)malloc(sizeof(autoware_auto_perception_msgs__msg__TrackedObjectKinematics));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_perception_msgs__msg__TrackedObjectKinematics__Sequence__init(autoware_auto_perception_msgs__msg__TrackedObjectKinematics__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_perception_msgs__msg__TrackedObjectKinematics *)calloc(size, sizeof(autoware_auto_perception_msgs__msg__TrackedObjectKinematics));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_perception_msgs__msg__TrackedObjectKinematics__Sequence * array = (autoware_auto_perception_msgs__msg__TrackedObjectKinematics__Sequence *)malloc(sizeof(autoware_auto_perception_msgs__msg__TrackedObjectKinematics__Sequence));
  if (!array) {
    return NULL;
  }
