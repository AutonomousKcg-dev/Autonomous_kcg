...
{
  autoware_auto_perception_msgs__msg__ClassifiedRoiArray * msg = (autoware_auto_perception_msgs__msg__ClassifiedRoiArray *)malloc(sizeof(autoware_auto_perception_msgs__msg__ClassifiedRoiArray));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_perception_msgs__msg__ClassifiedRoiArray__Sequence__init(autoware_auto_perception_msgs__msg__ClassifiedRoiArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_perception_msgs__msg__ClassifiedRoiArray *)calloc(size, sizeof(autoware_auto_perception_msgs__msg__ClassifiedRoiArray));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_perception_msgs__msg__ClassifiedRoiArray__Sequence * array = (autoware_auto_perception_msgs__msg__ClassifiedRoiArray__Sequence *)malloc(sizeof(autoware_auto_perception_msgs__msg__ClassifiedRoiArray__Sequence));
  if (!array) {
    return NULL;
  }
