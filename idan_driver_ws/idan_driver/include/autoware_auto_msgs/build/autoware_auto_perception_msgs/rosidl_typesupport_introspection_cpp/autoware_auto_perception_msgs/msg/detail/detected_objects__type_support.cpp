...
{
  new (message_memory) autoware_auto_perception_msgs::msg::DetectedObjects(_init);
}

void DetectedObjects_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_auto_perception_msgs::msg::DetectedObjects *>(message_memory);
  typed_message->~DetectedObjects();
}

size_t size_function__DetectedObjects__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<autoware_auto_perception_msgs::msg::DetectedObject> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<autoware_auto_perception_msgs::msg::DetectedObject> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<autoware_auto_perception_msgs::msg::DetectedObject> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectedObjects_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(autoware_auto_perception_msgs::msg::DetectedObjects, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_perception_msgs::msg::DetectedObjects, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectedObjects_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_auto_perception_msgs::msg::DetectedObjects),
...
get_message_type_support_handle<autoware_auto_perception_msgs::msg::DetectedObjects>()
{
  return &::autoware_auto_perception_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedObjects_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_perception_msgs, msg, DetectedObjects)() {
  return &::autoware_auto_perception_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedObjects_message_type_support_handle;
}
