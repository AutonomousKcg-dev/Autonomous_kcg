...
#include "autoware_auto_perception_msgs/msg/detail/point_clusters__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_perception_msgs/msg/detail/point_xyzif__functions.h"  // points
#include "rosidl_runtime_c/primitives_sequence.h"  // cluster_boundary
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // cluster_boundary
...
using _PointClusters__ros_msg_type = autoware_auto_perception_msgs__msg__PointClusters;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_perception_msgs, msg, PointXYZIF
      )()->data);
  ...
  // Field name: cluster_boundary
  {
    size_t size = ros_message->cluster_boundary.size;
    auto array_ptr = ros_message->cluster_boundary.data;
    cdr << static_cast<uint32_t>(size);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      autoware_auto_perception_msgs__msg__PointXYZIF__Sequence__fini(&ros_message->points);
    }
    if (!autoware_auto_perception_msgs__msg__PointXYZIF__Sequence__init(&ros_message->points, size)) {
  ...
  // Field name: cluster_boundary
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->cluster_boundary.data) {
      rosidl_runtime_c__uint32__Sequence__fini(&ros_message->cluster_boundary);
    }
    if (!rosidl_runtime_c__uint32__Sequence__init(&ros_message->cluster_boundary, size)) {
      return "failed to create array for field 'cluster_boundary'";
    }
    auto array_ptr = ros_message->cluster_boundary.data;
...
size_t get_serialized_size_autoware_auto_perception_msgs__msg__PointClusters(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PointClusters__ros_msg_type * ros_message = static_cast<const _PointClusters__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_autoware_auto_perception_msgs__msg__PointXYZIF(
...
static uint32_t _PointClusters__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_perception_msgs__msg__PointClusters(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_perception_msgs
size_t max_serialized_size_autoware_auto_perception_msgs__msg__PointClusters(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_perception_msgs__msg__PointXYZIF(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_autoware_auto_perception_msgs__msg__PointClusters(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_perception_msgs, msg, PointClusters)() {
