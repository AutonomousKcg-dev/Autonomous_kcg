...
#include "autoware_auto_perception_msgs/msg/detail/bounding_box__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_geometry_msgs/msg/detail/quaternion32__functions.h"  // orientation
...
using _BoundingBox__ros_msg_type = autoware_auto_perception_msgs__msg__BoundingBox;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: orientation
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_geometry_msgs, msg, Quaternion32
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_autoware_auto_geometry_msgs__msg__Quaternion32(
...
static uint32_t _BoundingBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_perception_msgs__msg__BoundingBox(
  ...
  size_t current_alignment)
{
  ...
  // member: orientation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_geometry_msgs__msg__Quaternion32(
        full_bounded, current_alignment);
    }
  }
  // member: velocity
...
{
  return max_serialized_size_autoware_auto_perception_msgs__msg__BoundingBox(
    full_bounded, 0);
}
