...
#include "autoware_auto_perception_msgs/msg/detail/detected_objects__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_perception_msgs/msg/detail/detected_object__functions.h"  // objects
...
using _DetectedObjects__ros_msg_type = autoware_auto_perception_msgs__msg__DetectedObjects;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: objects
  {
    ...
    if (ros_message->objects.data) {
      autoware_auto_perception_msgs__msg__DetectedObject__Sequence__fini(&ros_message->objects);
    }
    if (!autoware_auto_perception_msgs__msg__DetectedObject__Sequence__init(&ros_message->objects, size)) {
...
size_t get_serialized_size_autoware_auto_perception_msgs__msg__DetectedObjects(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DetectedObjects__ros_msg_type * ros_message = static_cast<const _DetectedObjects__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DetectedObjects__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_perception_msgs__msg__DetectedObjects(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_perception_msgs
size_t max_serialized_size_autoware_auto_perception_msgs__msg__DetectedObjects(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _DetectedObjects__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_perception_msgs__msg__DetectedObjects(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_perception_msgs, msg, DetectedObjects)() {
