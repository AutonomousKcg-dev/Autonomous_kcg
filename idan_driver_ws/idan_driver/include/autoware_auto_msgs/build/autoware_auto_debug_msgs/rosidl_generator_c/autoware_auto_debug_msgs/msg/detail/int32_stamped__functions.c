...
{
  autoware_auto_debug_msgs__msg__Int32Stamped * msg = (autoware_auto_debug_msgs__msg__Int32Stamped *)malloc(sizeof(autoware_auto_debug_msgs__msg__Int32Stamped));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__Int32Stamped__Sequence__init(autoware_auto_debug_msgs__msg__Int32Stamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_debug_msgs__msg__Int32Stamped *)calloc(size, sizeof(autoware_auto_debug_msgs__msg__Int32Stamped));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_debug_msgs__msg__Int32Stamped__Sequence * array = (autoware_auto_debug_msgs__msg__Int32Stamped__Sequence *)malloc(sizeof(autoware_auto_debug_msgs__msg__Int32Stamped__Sequence));
  if (!array) {
    return NULL;
  }
