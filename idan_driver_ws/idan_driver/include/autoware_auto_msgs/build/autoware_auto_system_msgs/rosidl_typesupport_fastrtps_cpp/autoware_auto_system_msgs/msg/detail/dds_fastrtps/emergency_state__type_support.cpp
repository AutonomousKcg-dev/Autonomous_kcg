...
#include "autoware_auto_system_msgs/msg/detail/emergency_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_system_msgs::msg::EmergencyState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_system_msgs::msg::EmergencyState & ros_message)
{
  // Member: stamp
...
{
  auto typed_message =
    static_cast<const autoware_auto_system_msgs::msg::EmergencyState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_system_msgs::msg::EmergencyState *>(
    untyped_ros_message);
...
{
  return max_serialized_size_EmergencyState(full_bounded, 0);
}
...
{
  return &autoware_auto_system_msgs::msg::typesupport_fastrtps_cpp::_EmergencyState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_system_msgs, msg, EmergencyState)() {
  return &autoware_auto_system_msgs::msg::typesupport_fastrtps_cpp::_EmergencyState__handle;
}
