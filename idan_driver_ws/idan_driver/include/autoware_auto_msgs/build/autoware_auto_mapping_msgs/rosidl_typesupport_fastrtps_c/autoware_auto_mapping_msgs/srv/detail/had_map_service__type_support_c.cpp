...
{
  return max_serialized_size_autoware_auto_mapping_msgs__srv__HADMapService_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_mapping_msgs__srv__HADMapService_Response(
    full_bounded, 0);
}
