...
#include "autoware_auto_mapping_msgs/msg/detail/had_map_bin__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_autoware_auto_mapping_msgs
...
using _HADMapBin__ros_msg_type = autoware_auto_mapping_msgs__msg__HADMapBin;
...
static uint32_t _HADMapBin__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_mapping_msgs__msg__HADMapBin(
...
{
  return max_serialized_size_autoware_auto_mapping_msgs__msg__HADMapBin(
    full_bounded, 0);
}
