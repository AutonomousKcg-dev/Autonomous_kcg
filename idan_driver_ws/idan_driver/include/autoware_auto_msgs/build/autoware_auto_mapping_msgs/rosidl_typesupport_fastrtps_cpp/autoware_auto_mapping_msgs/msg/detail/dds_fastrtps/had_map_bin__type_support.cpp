...
#include "autoware_auto_mapping_msgs/msg/detail/had_map_bin__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const autoware_auto_mapping_msgs::msg::HADMapBin *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_mapping_msgs::msg::HADMapBin *>(
    untyped_ros_message);
...
{
  return &autoware_auto_mapping_msgs::msg::typesupport_fastrtps_cpp::_HADMapBin__handle;
}
