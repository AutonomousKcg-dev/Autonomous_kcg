...
#include "autoware_auto_mapping_msgs/msg/detail/had_map_segment__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_mapping_msgs::msg::HADMapSegment & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_mapping_msgs::msg::HADMapSegment & ros_message)
{
  // Member: primitives
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const autoware_auto_mapping_msgs::msg::HADMapSegment *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_mapping_msgs::msg::HADMapSegment *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HADMapSegment__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_auto_mapping_msgs::msg::HADMapSegment *>(
...
static size_t _HADMapSegment__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_HADMapSegment(full_bounded, 0);
}

static message_type_support_callbacks_t _HADMapSegment__callbacks = {
...
static rosidl_message_type_support_t _HADMapSegment__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HADMapSegment__callbacks,
...
{
  return &autoware_auto_mapping_msgs::msg::typesupport_fastrtps_cpp::_HADMapSegment__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_mapping_msgs, msg, HADMapSegment)() {
  return &autoware_auto_mapping_msgs::msg::typesupport_fastrtps_cpp::_HADMapSegment__handle;
}
