...
struct HADMapSegment_
{
  ...
  using _primitives_type =
    std::vector<autoware_auto_mapping_msgs::msg::MapPrimitive_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_mapping_msgs::msg::MapPrimitive_<ContainerAllocator>>::other>;
  ...
  Type & set__primitives(
    const std::vector<autoware_auto_mapping_msgs::msg::MapPrimitive_<ContainerAllocator>, typename ContainerAllocator::template rebind<autoware_auto_mapping_msgs::msg::MapPrimitive_<ContainerAllocator>>::other> & _arg)
  {
