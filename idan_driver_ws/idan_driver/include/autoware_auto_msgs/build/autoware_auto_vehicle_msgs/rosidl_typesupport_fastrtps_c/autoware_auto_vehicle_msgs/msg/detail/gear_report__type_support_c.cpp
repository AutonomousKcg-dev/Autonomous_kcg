...
#include "autoware_auto_vehicle_msgs/msg/detail/gear_report__rosidl_typesupport_fastrtps_c.h"
...
using _GearReport__ros_msg_type = autoware_auto_vehicle_msgs__msg__GearReport;
...
size_t get_serialized_size_autoware_auto_vehicle_msgs__msg__GearReport(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GearReport__ros_msg_type * ros_message = static_cast<const _GearReport__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GearReport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_vehicle_msgs__msg__GearReport(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_vehicle_msgs
size_t max_serialized_size_autoware_auto_vehicle_msgs__msg__GearReport(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_auto_vehicle_msgs__msg__GearReport(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_vehicle_msgs, msg, GearReport)() {
