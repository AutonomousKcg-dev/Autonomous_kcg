...
{
  return max_serialized_size_autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response(
    full_bounded, 0);
}
