...
{
  autoware_auto_vehicle_msgs__msg__VehicleStateReport * msg = (autoware_auto_vehicle_msgs__msg__VehicleStateReport *)malloc(sizeof(autoware_auto_vehicle_msgs__msg__VehicleStateReport));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_vehicle_msgs__msg__VehicleStateReport__Sequence__init(autoware_auto_vehicle_msgs__msg__VehicleStateReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_vehicle_msgs__msg__VehicleStateReport *)calloc(size, sizeof(autoware_auto_vehicle_msgs__msg__VehicleStateReport));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_vehicle_msgs__msg__VehicleStateReport__Sequence * array = (autoware_auto_vehicle_msgs__msg__VehicleStateReport__Sequence *)malloc(sizeof(autoware_auto_vehicle_msgs__msg__VehicleStateReport__Sequence));
  if (!array) {
    return NULL;
  }
