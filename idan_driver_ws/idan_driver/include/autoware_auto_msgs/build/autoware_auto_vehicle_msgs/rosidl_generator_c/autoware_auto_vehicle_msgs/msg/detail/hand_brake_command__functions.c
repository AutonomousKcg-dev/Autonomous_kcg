...
{
  autoware_auto_vehicle_msgs__msg__HandBrakeCommand * msg = (autoware_auto_vehicle_msgs__msg__HandBrakeCommand *)malloc(sizeof(autoware_auto_vehicle_msgs__msg__HandBrakeCommand));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_vehicle_msgs__msg__HandBrakeCommand__Sequence__init(autoware_auto_vehicle_msgs__msg__HandBrakeCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_vehicle_msgs__msg__HandBrakeCommand *)calloc(size, sizeof(autoware_auto_vehicle_msgs__msg__HandBrakeCommand));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_vehicle_msgs__msg__HandBrakeCommand__Sequence * array = (autoware_auto_vehicle_msgs__msg__HandBrakeCommand__Sequence *)malloc(sizeof(autoware_auto_vehicle_msgs__msg__HandBrakeCommand__Sequence));
  if (!array) {
    return NULL;
  }
