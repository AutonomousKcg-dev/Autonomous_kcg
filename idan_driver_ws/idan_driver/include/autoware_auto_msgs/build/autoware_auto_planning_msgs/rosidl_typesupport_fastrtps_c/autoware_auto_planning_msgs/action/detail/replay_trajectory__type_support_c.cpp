...
static size_t _ReplayTrajectory_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_planning_msgs__action__ReplayTrajectory_Goal(
    full_bounded, 0);
}
...
static size_t _ReplayTrajectory_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_planning_msgs__action__ReplayTrajectory_Result(
    full_bounded, 0);
}
...
static size_t _ReplayTrajectory_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_planning_msgs__action__ReplayTrajectory_Feedback(
    full_bounded, 0);
}
...
static size_t _ReplayTrajectory_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Request(
    full_bounded, 0);
}
...
static size_t _ReplayTrajectory_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_planning_msgs__action__ReplayTrajectory_SendGoal_Response(
    full_bounded, 0);
}
...
static size_t _ReplayTrajectory_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Request(
    full_bounded, 0);
}
...
static size_t _ReplayTrajectory_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_planning_msgs__action__ReplayTrajectory_GetResult_Response(
    full_bounded, 0);
}
...
static size_t _ReplayTrajectory_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_planning_msgs__action__ReplayTrajectory_FeedbackMessage(
    full_bounded, 0);
}
