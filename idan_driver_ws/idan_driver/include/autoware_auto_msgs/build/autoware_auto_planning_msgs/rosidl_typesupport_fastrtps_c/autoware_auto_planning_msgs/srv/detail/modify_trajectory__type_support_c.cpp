...
{
  return max_serialized_size_autoware_auto_planning_msgs__srv__ModifyTrajectory_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_planning_msgs__srv__ModifyTrajectory_Response(
    full_bounded, 0);
}
