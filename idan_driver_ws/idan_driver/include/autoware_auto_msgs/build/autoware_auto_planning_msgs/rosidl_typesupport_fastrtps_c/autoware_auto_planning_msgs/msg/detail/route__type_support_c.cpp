...
#include "autoware_auto_planning_msgs/msg/detail/route__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_planning_msgs/msg/detail/trajectory_point__functions.h"  // goal_point, start_point
...
using _Route__ros_msg_type = autoware_auto_planning_msgs__msg__Route;
...
size_t get_serialized_size_autoware_auto_planning_msgs__msg__Route(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Route__ros_msg_type * ros_message = static_cast<const _Route__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Route__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_planning_msgs__msg__Route(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_planning_msgs
size_t max_serialized_size_autoware_auto_planning_msgs__msg__Route(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_auto_planning_msgs__msg__Route(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_planning_msgs, msg, Route)() {
