...
#include "autoware_auto_planning_msgs/msg/detail/had_map_route__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_mapping_msgs/msg/detail/had_map_segment__functions.h"  // segments
...
using _HADMapRoute__ros_msg_type = autoware_auto_planning_msgs__msg__HADMapRoute;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _HADMapRoute__ros_msg_type * ros_message = static_cast<const _HADMapRoute__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: segments
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_mapping_msgs, msg, HADMapSegment
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _HADMapRoute__ros_msg_type * ros_message = static_cast<_HADMapRoute__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: segments
  {
    ...
    if (ros_message->segments.data) {
      autoware_auto_mapping_msgs__msg__HADMapSegment__Sequence__fini(&ros_message->segments);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_autoware_auto_mapping_msgs__msg__HADMapSegment(
...
static uint32_t _HADMapRoute__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_planning_msgs__msg__HADMapRoute(
  ...
  size_t current_alignment)
{
  ...
  // member: segments
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_mapping_msgs__msg__HADMapSegment(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_autoware_auto_planning_msgs__msg__HADMapRoute(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_HADMapRoute = {
...
static rosidl_message_type_support_t _HADMapRoute__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_HADMapRoute,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_planning_msgs, msg, HADMapRoute)() {
  return &_HADMapRoute__type_support;
}
