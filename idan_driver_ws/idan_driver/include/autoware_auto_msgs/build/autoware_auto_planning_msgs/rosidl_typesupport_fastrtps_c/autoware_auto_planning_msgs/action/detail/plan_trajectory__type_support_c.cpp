...
{
  return max_serialized_size_autoware_auto_planning_msgs__action__PlanTrajectory_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_planning_msgs__action__PlanTrajectory_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_planning_msgs__action__PlanTrajectory_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_planning_msgs__action__PlanTrajectory_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_planning_msgs__action__PlanTrajectory_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_planning_msgs__action__PlanTrajectory_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_planning_msgs__action__PlanTrajectory_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_autoware_auto_planning_msgs__action__PlanTrajectory_FeedbackMessage(
    full_bounded, 0);
}
