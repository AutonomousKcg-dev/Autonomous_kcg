...
{
  autoware_auto_planning_msgs__msg__TrajectoryPoint * msg = (autoware_auto_planning_msgs__msg__TrajectoryPoint *)malloc(sizeof(autoware_auto_planning_msgs__msg__TrajectoryPoint));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_planning_msgs__msg__TrajectoryPoint__Sequence__init(autoware_auto_planning_msgs__msg__TrajectoryPoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_planning_msgs__msg__TrajectoryPoint *)calloc(size, sizeof(autoware_auto_planning_msgs__msg__TrajectoryPoint));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_planning_msgs__msg__TrajectoryPoint__Sequence * array = (autoware_auto_planning_msgs__msg__TrajectoryPoint__Sequence *)malloc(sizeof(autoware_auto_planning_msgs__msg__TrajectoryPoint__Sequence));
  if (!array) {
    return NULL;
  }
