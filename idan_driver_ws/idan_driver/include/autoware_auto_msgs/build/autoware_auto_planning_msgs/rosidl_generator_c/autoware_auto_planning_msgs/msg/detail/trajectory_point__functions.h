...
#ifndef AUTOWARE_AUTO_PLANNING_MSGS__MSG__DETAIL__TRAJECTORY_POINT__FUNCTIONS_H_
#define AUTOWARE_AUTO_PLANNING_MSGS__MSG__DETAIL__TRAJECTORY_POINT__FUNCTIONS_H_
 ...
 * calls
 * autoware_auto_planning_msgs__msg__TrajectoryPoint__init().
...
/**
 * It calls
 * autoware_auto_planning_msgs__msg__TrajectoryPoint__fini()
 ...
 * autoware_auto_planning_msgs__msg__TrajectoryPoint__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_auto_planning_msgs__msg__TrajectoryPoint__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_AUTO_PLANNING_MSGS__MSG__DETAIL__TRAJECTORY_POINT__FUNCTIONS_H_
