...
{
  autoware_auto_planning_msgs__msg__Route * msg = (autoware_auto_planning_msgs__msg__Route *)malloc(sizeof(autoware_auto_planning_msgs__msg__Route));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_planning_msgs__msg__Route__Sequence__init(autoware_auto_planning_msgs__msg__Route__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_planning_msgs__msg__Route *)calloc(size, sizeof(autoware_auto_planning_msgs__msg__Route));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_planning_msgs__msg__Route__Sequence * array = (autoware_auto_planning_msgs__msg__Route__Sequence *)malloc(sizeof(autoware_auto_planning_msgs__msg__Route__Sequence));
  if (!array) {
    return NULL;
  }
