...
{
  return max_serialized_size_ReplayTrajectory_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_ReplayTrajectory_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_ReplayTrajectory_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_ReplayTrajectory_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_ReplayTrajectory_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_ReplayTrajectory_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_ReplayTrajectory_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_ReplayTrajectory_FeedbackMessage(full_bounded, 0);
}
