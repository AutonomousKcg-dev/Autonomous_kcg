...
{
  return max_serialized_size_PlannerCostmap_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_PlannerCostmap_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_PlannerCostmap_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_PlannerCostmap_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_PlannerCostmap_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_PlannerCostmap_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_PlannerCostmap_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_PlannerCostmap_FeedbackMessage(full_bounded, 0);
}
