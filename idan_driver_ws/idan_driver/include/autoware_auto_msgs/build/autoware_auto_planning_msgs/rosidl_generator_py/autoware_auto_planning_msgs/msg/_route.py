...
class Route(metaclass=Metaclass_Route):
    ...
    _fields_and_field_types = {
        ...
        'start_point': 'autoware_auto_planning_msgs/TrajectoryPoint',
        'goal_point': 'autoware_auto_planning_msgs/TrajectoryPoint',
        'primitives': 'sequence<autoware_auto_mapping_msgs/MapPrimitive, 100>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['autoware_auto_planning_msgs', 'msg'], 'TrajectoryPoint'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['autoware_auto_mapping_msgs', 'msg'], 'MapPrimitive'), 100),  # noqa: E501
    )
