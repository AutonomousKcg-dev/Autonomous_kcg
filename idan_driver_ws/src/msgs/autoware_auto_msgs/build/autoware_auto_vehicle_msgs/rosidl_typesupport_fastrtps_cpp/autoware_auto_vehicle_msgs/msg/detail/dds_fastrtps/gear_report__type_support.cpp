...
#include "autoware_auto_vehicle_msgs/msg/detail/gear_report__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_vehicle_msgs::msg::GearReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_vehicle_msgs::msg::GearReport & ros_message)
{
  // Member: stamp
...
{
  auto typed_message =
    static_cast<const autoware_auto_vehicle_msgs::msg::GearReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_vehicle_msgs::msg::GearReport *>(
    untyped_ros_message);
...
{
  return &autoware_auto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_GearReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_vehicle_msgs, msg, GearReport)() {
  return &autoware_auto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_GearReport__handle;
}
