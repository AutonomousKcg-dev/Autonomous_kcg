...
{
  autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request * msg = (autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request *)malloc(sizeof(autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request__Sequence__init(autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request *)calloc(size, sizeof(autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request));
    if (!data) {
      return false;
    }
...
{
  autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request__Sequence * array = (autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request__Sequence *)malloc(sizeof(autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response * msg = (autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response *)malloc(sizeof(autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response));
  if (!msg) {
    return NULL;
  }
...
autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response__Sequence__init(autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response *)calloc(size, sizeof(autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response__Sequence * array = (autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response__Sequence *)malloc(sizeof(autoware_auto_vehicle_msgs__srv__AutonomyModeChange_Response__Sequence));
  if (!array) {
    return NULL;
  }
