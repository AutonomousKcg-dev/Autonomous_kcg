...
#include "autoware_auto_msgs/msg/detail/vehicle_control_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_msgs::msg::VehicleControlCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_msgs::msg::VehicleControlCommand & ros_message)
{
  // Member: stamp
...
{
  auto typed_message =
    static_cast<const autoware_auto_msgs::msg::VehicleControlCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_msgs::msg::VehicleControlCommand *>(
    untyped_ros_message);
...
static size_t _VehicleControlCommand__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_VehicleControlCommand(full_bounded, 0);
}
...
{
  return &autoware_auto_msgs::msg::typesupport_fastrtps_cpp::_VehicleControlCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_msgs, msg, VehicleControlCommand)() {
  return &autoware_auto_msgs::msg::typesupport_fastrtps_cpp::_VehicleControlCommand__handle;
}
