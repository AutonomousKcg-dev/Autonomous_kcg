...
bool ros_g29_force_feedback__msg__force_feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_g29_force_feedback.msg._force_feedback.ForceFeedback", full_classname_dest, 56) == 0);
  }
  ros_g29_force_feedback__msg__ForceFeedback * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ForceFeedback */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_g29_force_feedback.msg._force_feedback");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ForceFeedback");
