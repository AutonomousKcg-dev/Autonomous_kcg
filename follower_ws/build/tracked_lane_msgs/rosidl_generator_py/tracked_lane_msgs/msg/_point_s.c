...
bool tracked_lane_msgs__msg__point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tracked_lane_msgs.msg._point.Point", full_classname_dest, 34) == 0);
  }
  tracked_lane_msgs__msg__Point * ros_message = _ros_message;
  {  // u
...
PyObject * tracked_lane_msgs__msg__point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tracked_lane_msgs.msg._point");
