...
static const _Point_type_support_symbol_names_t _Point_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tracked_lane_msgs, msg, Point)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tracked_lane_msgs, msg, Point)),
  }
};
...
{
  return &::tracked_lane_msgs::msg::rosidl_typesupport_cpp::Point_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tracked_lane_msgs, msg, Point)() {
  return get_message_type_support_handle<tracked_lane_msgs::msg::Point>();
}
