...
#include "additional_msgs/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _CanPacket_type_support_symbol_names_t _CanPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, additional_msgs, msg, CanPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, additional_msgs, msg, CanPacket)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_additional_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, additional_msgs, msg, CanPacket)() {
  return &::additional_msgs::msg::rosidl_typesupport_c::CanPacket_message_type_support_handle;
}
