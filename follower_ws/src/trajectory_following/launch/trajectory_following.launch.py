...
def generate_launch_description():
    # change to test.txt from param/trajectories/full_trajectory
    
    traj_file_name = "src/control/record_traj/param/example.txt"
    #get_share_file('record_traj', 'param/test.txt')
