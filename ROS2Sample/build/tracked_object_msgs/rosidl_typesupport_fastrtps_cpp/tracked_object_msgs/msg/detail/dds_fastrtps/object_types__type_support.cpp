...
#include "tracked_object_msgs/msg/detail/object_types__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tracked_object_msgs::msg::ObjectTypes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tracked_object_msgs::msg::ObjectTypes *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectTypes__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tracked_object_msgs::msg::ObjectTypes *>(
...
{
  return max_serialized_size_ObjectTypes(full_bounded, 0);
}

static message_type_support_callbacks_t _ObjectTypes__callbacks = {
...
static rosidl_message_type_support_t _ObjectTypes__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectTypes__callbacks,
...
{
  return &tracked_object_msgs::msg::typesupport_fastrtps_cpp::_ObjectTypes__handle;
}
