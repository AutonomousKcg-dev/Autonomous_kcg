...
static const _ObjectTypes_type_support_symbol_names_t _ObjectTypes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tracked_object_msgs, msg, ObjectTypes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tracked_object_msgs, msg, ObjectTypes)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tracked_object_msgs, msg, ObjectTypes)() {
  return &::tracked_object_msgs::msg::rosidl_typesupport_c::ObjectTypes_message_type_support_handle;
}
