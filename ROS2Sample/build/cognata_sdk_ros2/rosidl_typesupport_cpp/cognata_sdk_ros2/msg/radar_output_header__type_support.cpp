...
static const _RadarOutputHeader_type_support_symbol_names_t _RadarOutputHeader_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cognata_sdk_ros2, msg, RadarOutputHeader)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cognata_sdk_ros2, msg, RadarOutputHeader)),
  }
};
...
{
  return &::cognata_sdk_ros2::msg::rosidl_typesupport_cpp::RadarOutputHeader_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cognata_sdk_ros2, msg, RadarOutputHeader)() {
  return get_message_type_support_handle<cognata_sdk_ros2::msg::RadarOutputHeader>();
}
