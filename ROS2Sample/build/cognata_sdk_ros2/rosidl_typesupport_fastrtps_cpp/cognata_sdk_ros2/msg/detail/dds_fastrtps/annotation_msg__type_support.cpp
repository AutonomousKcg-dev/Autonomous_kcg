...
#include "cognata_sdk_ros2/msg/detail/annotation_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const cognata_sdk_ros2::msg::AnnotationMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cognata_sdk_ros2::msg::AnnotationMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AnnotationMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cognata_sdk_ros2::msg::AnnotationMsg *>(
...
{
  return max_serialized_size_AnnotationMsg(full_bounded, 0);
}

static message_type_support_callbacks_t _AnnotationMsg__callbacks = {
...
static rosidl_message_type_support_t _AnnotationMsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AnnotationMsg__callbacks,
...
{
  return &cognata_sdk_ros2::msg::typesupport_fastrtps_cpp::_AnnotationMsg__handle;
}
