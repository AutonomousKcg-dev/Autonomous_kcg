...
bool cognata_sdk_ros2__msg__bounding_box_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cognata_sdk_ros2.msg._bounding_box_msg.BoundingBoxMsg", full_classname_dest, 53) == 0);
  }
  cognata_sdk_ros2__msg__BoundingBoxMsg * ros_message = _ros_message;
  {  // transform
...
{
  /* NOTE(esteve): Call constructor of BoundingBoxMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cognata_sdk_ros2.msg._bounding_box_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoundingBoxMsg");
