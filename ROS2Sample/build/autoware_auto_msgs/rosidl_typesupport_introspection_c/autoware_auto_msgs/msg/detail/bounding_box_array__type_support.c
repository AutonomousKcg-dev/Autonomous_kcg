  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_auto_msgs__msg__BoundingBoxArray__init(message_memory);
}

void BoundingBoxArray__rosidl_typesupport_introspection_c__BoundingBoxArray_fini_function(void * message_memory)
{
  autoware_auto_msgs__msg__BoundingBoxArray__fini(message_memory);
}

size_t BoundingBoxArray__rosidl_typesupport_introspection_c__size_function__BoundingBox__boxes(
  const void * untyped_member)
{
  const autoware_auto_msgs__msg__BoundingBox__Sequence * member =
    (const autoware_auto_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  return member->size;
}
...
{
  autoware_auto_msgs__msg__BoundingBox__Sequence * member =
    (autoware_auto_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  autoware_auto_msgs__msg__BoundingBox__Sequence * member =
    (autoware_auto_msgs__msg__BoundingBox__Sequence *)(untyped_member);
  autoware_auto_msgs__msg__BoundingBox__Sequence__fini(member);
  return autoware_auto_msgs__msg__BoundingBox__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember BoundingBoxArray__rosidl_typesupport_introspection_c__BoundingBoxArray_message_member_array[2] = {
  {
    ...
    offsetof(autoware_auto_msgs__msg__BoundingBoxArray, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    256,  // array size
    true,  // is upper bound
    offsetof(autoware_auto_msgs__msg__BoundingBoxArray, boxes),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers BoundingBoxArray__rosidl_typesupport_introspection_c__BoundingBoxArray_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_auto_msgs__msg__BoundingBoxArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, msg, BoundingBoxArray)() {
