...
#ifndef AUTOWARE_AUTO_MSGS__MSG__DETAIL__TRAJECTORY_POINT__STRUCT_HPP_
#define AUTOWARE_AUTO_MSGS__MSG__DETAIL__TRAJECTORY_POINT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_auto_msgs__msg__TrajectoryPoint __attribute__((deprecated))
#else
# define DEPRECATED__autoware_auto_msgs__msg__TrajectoryPoint __declspec(deprecated)
#endif
...
struct TrajectoryPoint_
{
  ...
  _y_type y;
  using _heading_type =
    autoware_auto_msgs::msg::Complex32_<ContainerAllocator>;
  ...
  Type & set__heading(
    const autoware_auto_msgs::msg::Complex32_<ContainerAllocator> & _arg)
  {
    this->heading = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_auto_msgs__msg__TrajectoryPoint
    std::shared_ptr<autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_auto_msgs__msg__TrajectoryPoint
    std::shared_ptr<autoware_auto_msgs::msg::TrajectoryPoint_<ContainerAllocator> const>
...
using TrajectoryPoint =
  autoware_auto_msgs::msg::TrajectoryPoint_<std::allocator<void>>;
...
#endif  // AUTOWARE_AUTO_MSGS__MSG__DETAIL__TRAJECTORY_POINT__STRUCT_HPP_
