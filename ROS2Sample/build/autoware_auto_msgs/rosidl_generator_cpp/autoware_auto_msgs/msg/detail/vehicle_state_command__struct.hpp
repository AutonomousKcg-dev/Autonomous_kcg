...
#ifndef AUTOWARE_AUTO_MSGS__MSG__DETAIL__VEHICLE_STATE_COMMAND__STRUCT_HPP_
#define AUTOWARE_AUTO_MSGS__MSG__DETAIL__VEHICLE_STATE_COMMAND__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_auto_msgs__msg__VehicleStateCommand __attribute__((deprecated))
#else
# define DEPRECATED__autoware_auto_msgs__msg__VehicleStateCommand __declspec(deprecated)
#endif
...
struct VehicleStateCommand_
{
  ...
  // pointer types
  using RawPtr =
    autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_auto_msgs__msg__VehicleStateCommand
    std::shared_ptr<autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_auto_msgs__msg__VehicleStateCommand
    std::shared_ptr<autoware_auto_msgs::msg::VehicleStateCommand_<ContainerAllocator> const>
...
using VehicleStateCommand =
  autoware_auto_msgs::msg::VehicleStateCommand_<std::allocator<void>>;
...
#endif  // AUTOWARE_AUTO_MSGS__MSG__DETAIL__VEHICLE_STATE_COMMAND__STRUCT_HPP_
