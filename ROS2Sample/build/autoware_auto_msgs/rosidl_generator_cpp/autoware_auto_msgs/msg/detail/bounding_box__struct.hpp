...
#ifndef AUTOWARE_AUTO_MSGS__MSG__DETAIL__BOUNDING_BOX__STRUCT_HPP_
#define AUTOWARE_AUTO_MSGS__MSG__DETAIL__BOUNDING_BOX__STRUCT_HPP_
...
// Member 'orientation'
#include "autoware_auto_msgs/msg/detail/quaternion32__struct.hpp"

#ifndef _WIN32
# define DEPRECATED__autoware_auto_msgs__msg__BoundingBox __attribute__((deprecated))
#else
# define DEPRECATED__autoware_auto_msgs__msg__BoundingBox __declspec(deprecated)
#endif
...
struct BoundingBox_
{
  ...
  Type & set__orientation(
    const autoware_auto_msgs::msg::Quaternion32_<ContainerAllocator> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_auto_msgs__msg__BoundingBox
    std::shared_ptr<autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_auto_msgs__msg__BoundingBox
    std::shared_ptr<autoware_auto_msgs::msg::BoundingBox_<ContainerAllocator> const>
...
using BoundingBox =
  autoware_auto_msgs::msg::BoundingBox_<std::allocator<void>>;
...
#endif  // AUTOWARE_AUTO_MSGS__MSG__DETAIL__BOUNDING_BOX__STRUCT_HPP_
