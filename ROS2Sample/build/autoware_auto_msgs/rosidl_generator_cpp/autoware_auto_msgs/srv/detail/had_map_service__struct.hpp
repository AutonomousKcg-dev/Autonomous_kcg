...
#ifndef AUTOWARE_AUTO_MSGS__SRV__DETAIL__HAD_MAP_SERVICE__STRUCT_HPP_
#define AUTOWARE_AUTO_MSGS__SRV__DETAIL__HAD_MAP_SERVICE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_auto_msgs__srv__HADMapService_Request __attribute__((deprecated))
#else
# define DEPRECATED__autoware_auto_msgs__srv__HADMapService_Request __declspec(deprecated)
#endif
...
struct HADMapService_Request_
{
  ...
  // pointer types
  using RawPtr =
    autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_auto_msgs__srv__HADMapService_Request
    std::shared_ptr<autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_auto_msgs__srv__HADMapService_Request
    std::shared_ptr<autoware_auto_msgs::srv::HADMapService_Request_<ContainerAllocator> const>
...
using HADMapService_Request =
  autoware_auto_msgs::srv::HADMapService_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__autoware_auto_msgs__srv__HADMapService_Response __attribute__((deprecated))
#else
# define DEPRECATED__autoware_auto_msgs__srv__HADMapService_Response __declspec(deprecated)
#endif
...
struct HADMapService_Response_
{
  ...
  // field types and members
  using _map_type =
    autoware_auto_msgs::msg::HADMapBin_<ContainerAllocator>;
  _map_type map;
  using _answer_type =
    int32_t;
  _answer_type answer;
  ...
  // setters for named parameter idiom
  Type & set__map(
    const autoware_auto_msgs::msg::HADMapBin_<ContainerAllocator> & _arg)
  {
    this->map = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_auto_msgs__srv__HADMapService_Response
    std::shared_ptr<autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_auto_msgs__srv__HADMapService_Response
    std::shared_ptr<autoware_auto_msgs::srv::HADMapService_Response_<ContainerAllocator> const>
...
using HADMapService_Response =
  autoware_auto_msgs::srv::HADMapService_Response_<std::allocator<void>>;
...
{
  using Request = autoware_auto_msgs::srv::HADMapService_Request;
  using Response = autoware_auto_msgs::srv::HADMapService_Response;
};
...
#endif  // AUTOWARE_AUTO_MSGS__SRV__DETAIL__HAD_MAP_SERVICE__STRUCT_HPP_
