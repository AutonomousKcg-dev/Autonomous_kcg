...
#include "autoware_auto_msgs/srv/detail/had_map_service__rosidl_typesupport_fastrtps_c.h"
...
using _HADMapService_Request__ros_msg_type = autoware_auto_msgs__srv__HADMapService_Request;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: requested_primitives
  {
    ...
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->requested_primitives, size)) {
      return "failed to create array for field 'requested_primitives'";
    }
    auto array_ptr = ros_message->requested_primitives.data;
  ...
  // Field name: geom_upper_bound
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->geom_upper_bound, size)) {
      return "failed to create array for field 'geom_upper_bound'";
    }
    auto array_ptr = ros_message->geom_upper_bound.data;
    cdr.deserializeArray(array_ptr, size);
  }
  ...
  // Field name: geom_lower_bound
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->geom_lower_bound, size)) {
      return "failed to create array for field 'geom_lower_bound'";
    }
    auto array_ptr = ros_message->geom_lower_bound.data;
    cdr.deserializeArray(array_ptr, size);
  }
...
size_t get_serialized_size_autoware_auto_msgs__srv__HADMapService_Request(
  const void * untyped_ros_message,
...
static uint32_t _HADMapService_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__srv__HADMapService_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__srv__HADMapService_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_auto_msgs__srv__HADMapService_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, HADMapService_Request)() {
...
#include "autoware_auto_msgs/msg/detail/had_map_bin__functions.h"  // map
...
using _HADMapService_Response__ros_msg_type = autoware_auto_msgs__srv__HADMapService_Response;
  ...
  // Field name: map
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, HADMapBin
      )()->data);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__srv__HADMapService_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HADMapService_Response__ros_msg_type * ros_message = static_cast<const _HADMapService_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_autoware_auto_msgs__msg__HADMapBin(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__srv__HADMapService_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__srv__HADMapService_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: map
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_msgs__msg__HADMapBin(
...
{
  return max_serialized_size_autoware_auto_msgs__srv__HADMapService_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, HADMapService_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, HADMapService)() {
