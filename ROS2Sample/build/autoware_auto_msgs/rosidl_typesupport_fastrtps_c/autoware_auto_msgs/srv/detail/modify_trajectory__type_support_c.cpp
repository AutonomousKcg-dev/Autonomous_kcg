...
#include "autoware_auto_msgs/srv/detail/modify_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_msgs/msg/detail/trajectory__functions.h"  // original_trajectory
...
using _ModifyTrajectory_Request__ros_msg_type = autoware_auto_msgs__srv__ModifyTrajectory_Request;
...
size_t get_serialized_size_autoware_auto_msgs__srv__ModifyTrajectory_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ModifyTrajectory_Request__ros_msg_type * ros_message = static_cast<const _ModifyTrajectory_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ModifyTrajectory_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__srv__ModifyTrajectory_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__srv__ModifyTrajectory_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _ModifyTrajectory_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_msgs__srv__ModifyTrajectory_Request(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ModifyTrajectory_Request = {
  "autoware_auto_msgs::srv",
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, ModifyTrajectory_Request)() {
...
// already included above
// #include "autoware_auto_msgs/msg/detail/trajectory__functions.h"  // modified_trajectory
...
using _ModifyTrajectory_Response__ros_msg_type = autoware_auto_msgs__srv__ModifyTrajectory_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__srv__ModifyTrajectory_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ModifyTrajectory_Response__ros_msg_type * ros_message = static_cast<const _ModifyTrajectory_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__srv__ModifyTrajectory_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__srv__ModifyTrajectory_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _ModifyTrajectory_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_msgs__srv__ModifyTrajectory_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, ModifyTrajectory_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, ModifyTrajectory)() {
