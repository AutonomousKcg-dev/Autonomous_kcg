...
#include "autoware_auto_msgs/srv/detail/autonomy_mode_change__rosidl_typesupport_fastrtps_c.h"
...
using _AutonomyModeChange_Request__ros_msg_type = autoware_auto_msgs__srv__AutonomyModeChange_Request;
...
size_t get_serialized_size_autoware_auto_msgs__srv__AutonomyModeChange_Request(
  const void * untyped_ros_message,
...
static uint32_t _AutonomyModeChange_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__srv__AutonomyModeChange_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__srv__AutonomyModeChange_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_auto_msgs__srv__AutonomyModeChange_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, AutonomyModeChange_Request)() {
...
using _AutonomyModeChange_Response__ros_msg_type = autoware_auto_msgs__srv__AutonomyModeChange_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__srv__AutonomyModeChange_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AutonomyModeChange_Response__ros_msg_type * ros_message = static_cast<const _AutonomyModeChange_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__srv__AutonomyModeChange_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__srv__AutonomyModeChange_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_auto_msgs__srv__AutonomyModeChange_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, AutonomyModeChange_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, AutonomyModeChange)() {
