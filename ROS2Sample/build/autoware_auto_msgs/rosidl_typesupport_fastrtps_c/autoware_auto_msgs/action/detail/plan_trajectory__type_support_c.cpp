...
#include "autoware_auto_msgs/action/detail/plan_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_msgs/msg/detail/route__functions.h"  // sub_route

// forward declare type support functions
size_t get_serialized_size_autoware_auto_msgs__msg__Route(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_autoware_auto_msgs__msg__Route(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, Route)();


using _PlanTrajectory_Goal__ros_msg_type = autoware_auto_msgs__action__PlanTrajectory_Goal;
  ...
  // Field name: sub_route
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, Route
      )()->data);
...
size_t get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanTrajectory_Goal__ros_msg_type * ros_message = static_cast<const _PlanTrajectory_Goal__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_autoware_auto_msgs__msg__Route(
...
static uint32_t _PlanTrajectory_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Goal(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: sub_route
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_msgs__msg__Route(
...
{
  return max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Goal(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_Goal)() {
...
#include "autoware_auto_msgs/msg/detail/trajectory__functions.h"  // trajectory

// forward declare type support functions
size_t get_serialized_size_autoware_auto_msgs__msg__Trajectory(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_autoware_auto_msgs__msg__Trajectory(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, Trajectory)();


using _PlanTrajectory_Result__ros_msg_type = autoware_auto_msgs__action__PlanTrajectory_Result;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: trajectory
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, Trajectory
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanTrajectory_Result__ros_msg_type * ros_message = static_cast<const _PlanTrajectory_Result__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_autoware_auto_msgs__msg__Trajectory(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Result(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_msgs__msg__Trajectory(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Result(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_Result)() {
...
using _PlanTrajectory_Feedback__ros_msg_type = autoware_auto_msgs__action__PlanTrajectory_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanTrajectory_Feedback__ros_msg_type * ros_message = static_cast<const _PlanTrajectory_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Feedback(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Feedback(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_Feedback)() {
...
// already included above
// #include "autoware_auto_msgs/action/detail/plan_trajectory__functions.h"  // goal
...
using _PlanTrajectory_SendGoal_Request__ros_msg_type = autoware_auto_msgs__action__PlanTrajectory_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanTrajectory_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _PlanTrajectory_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_SendGoal_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Goal(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_SendGoal_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_SendGoal_Request)() {
...
using _PlanTrajectory_SendGoal_Response__ros_msg_type = autoware_auto_msgs__action__PlanTrajectory_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanTrajectory_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _PlanTrajectory_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_SendGoal_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_SendGoal_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_SendGoal)() {
...
using _PlanTrajectory_GetResult_Request__ros_msg_type = autoware_auto_msgs__action__PlanTrajectory_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanTrajectory_GetResult_Request__ros_msg_type * ros_message = static_cast<const _PlanTrajectory_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_GetResult_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_GetResult_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_GetResult_Request)() {
...
// already included above
// #include "autoware_auto_msgs/action/detail/plan_trajectory__functions.h"  // result
...
using _PlanTrajectory_GetResult_Response__ros_msg_type = autoware_auto_msgs__action__PlanTrajectory_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanTrajectory_GetResult_Response__ros_msg_type * ros_message = static_cast<const _PlanTrajectory_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_GetResult_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Result(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_GetResult_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_GetResult)() {
...
// already included above
// #include "autoware_auto_msgs/action/detail/plan_trajectory__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _PlanTrajectory_FeedbackMessage__ros_msg_type = autoware_auto_msgs__action__PlanTrajectory_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanTrajectory_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _PlanTrajectory_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__action__PlanTrajectory_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_FeedbackMessage(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_Feedback(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_autoware_auto_msgs__action__PlanTrajectory_FeedbackMessage(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, action, PlanTrajectory_FeedbackMessage)() {
