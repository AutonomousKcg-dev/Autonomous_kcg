...
#include "autoware_auto_msgs/msg/detail/quaternion32__rosidl_typesupport_fastrtps_c.h"
...
using _Quaternion32__ros_msg_type = autoware_auto_msgs__msg__Quaternion32;
...
static uint32_t _Quaternion32__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__msg__Quaternion32(
...
{
  return max_serialized_size_autoware_auto_msgs__msg__Quaternion32(
    full_bounded, 0);
}
