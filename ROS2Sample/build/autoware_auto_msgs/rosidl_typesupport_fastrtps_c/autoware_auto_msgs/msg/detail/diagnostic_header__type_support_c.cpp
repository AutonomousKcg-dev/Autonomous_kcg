...
#include "autoware_auto_msgs/msg/detail/diagnostic_header__rosidl_typesupport_fastrtps_c.h"
...
using _DiagnosticHeader__ros_msg_type = autoware_auto_msgs__msg__DiagnosticHeader;
...
static uint32_t _DiagnosticHeader__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__msg__DiagnosticHeader(
...
{
  return max_serialized_size_autoware_auto_msgs__msg__DiagnosticHeader(
    full_bounded, 0);
}
