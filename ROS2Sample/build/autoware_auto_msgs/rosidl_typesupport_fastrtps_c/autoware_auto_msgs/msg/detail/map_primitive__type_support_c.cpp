...
#include "autoware_auto_msgs/msg/detail/map_primitive__rosidl_typesupport_fastrtps_c.h"
...
using _MapPrimitive__ros_msg_type = autoware_auto_msgs__msg__MapPrimitive;
...
static uint32_t _MapPrimitive__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__msg__MapPrimitive(
...
{
  return max_serialized_size_autoware_auto_msgs__msg__MapPrimitive(
    full_bounded, 0);
}
