...
#include "autoware_auto_msgs/msg/detail/control_diagnostic__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_msgs/msg/detail/diagnostic_header__functions.h"  // diag_header
...
size_t get_serialized_size_autoware_auto_msgs__msg__DiagnosticHeader(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_autoware_auto_msgs__msg__DiagnosticHeader(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, DiagnosticHeader)();


using _ControlDiagnostic__ros_msg_type = autoware_auto_msgs__msg__ControlDiagnostic;
  ...
  // Field name: diag_header
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, DiagnosticHeader
      )()->data);
...
size_t get_serialized_size_autoware_auto_msgs__msg__ControlDiagnostic(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ControlDiagnostic__ros_msg_type * ros_message = static_cast<const _ControlDiagnostic__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_autoware_auto_msgs__msg__DiagnosticHeader(
...
static uint32_t _ControlDiagnostic__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__msg__ControlDiagnostic(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__msg__ControlDiagnostic(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: diag_header
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_msgs__msg__DiagnosticHeader(
...
static size_t _ControlDiagnostic__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_autoware_auto_msgs__msg__ControlDiagnostic(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, ControlDiagnostic)() {
