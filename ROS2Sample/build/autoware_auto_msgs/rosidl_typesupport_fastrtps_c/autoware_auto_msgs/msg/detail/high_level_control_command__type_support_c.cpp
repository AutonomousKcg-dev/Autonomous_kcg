...
#include "autoware_auto_msgs/msg/detail/high_level_control_command__rosidl_typesupport_fastrtps_c.h"
...
using _HighLevelControlCommand__ros_msg_type = autoware_auto_msgs__msg__HighLevelControlCommand;
...
size_t get_serialized_size_autoware_auto_msgs__msg__HighLevelControlCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HighLevelControlCommand__ros_msg_type * ros_message = static_cast<const _HighLevelControlCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _HighLevelControlCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__msg__HighLevelControlCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_msgs
size_t max_serialized_size_autoware_auto_msgs__msg__HighLevelControlCommand(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_autoware_auto_msgs__msg__HighLevelControlCommand(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, HighLevelControlCommand)() {
