...
#include "autoware_auto_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_msgs/msg/detail/trajectory_point__functions.h"  // points
...
using _Trajectory__ros_msg_type = autoware_auto_msgs__msg__Trajectory;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      autoware_auto_msgs__msg__TrajectoryPoint__Sequence__fini(&ros_message->points);
    }
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__msg__Trajectory(
...
{
  return max_serialized_size_autoware_auto_msgs__msg__Trajectory(
    full_bounded, 0);
}
