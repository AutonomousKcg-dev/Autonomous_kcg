...
#include "autoware_auto_msgs/msg/detail/route__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_msgs/msg/detail/map_primitive__functions.h"  // primitives
#include "autoware_auto_msgs/msg/detail/trajectory_point__functions.h"  // goal_point, start_point
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_autoware_auto_msgs__msg__MapPrimitive(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_autoware_auto_msgs__msg__MapPrimitive(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, MapPrimitive)();
...
using _Route__ros_msg_type = autoware_auto_msgs__msg__Route;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: start_point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, TrajectoryPoint
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: primitives
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_msgs, msg, MapPrimitive
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: primitives
  {
    ...
    if (ros_message->primitives.data) {
      autoware_auto_msgs__msg__MapPrimitive__Sequence__fini(&ros_message->primitives);
    }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_autoware_auto_msgs__msg__TrajectoryPoint(
  ...
  // field.name primitives
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_autoware_auto_msgs__msg__MapPrimitive(
...
static uint32_t _Route__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_msgs__msg__Route(
  ...
  size_t current_alignment)
{
  ...
  // member: start_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_msgs__msg__TrajectoryPoint(
        full_bounded, current_alignment);
    }
  }
  // member: goal_point
  ...
  // member: primitives
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_autoware_auto_msgs__msg__MapPrimitive(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_autoware_auto_msgs__msg__Route(
    full_bounded, 0);
}
