...
#include "autoware_auto_msgs/srv/detail/had_map_service__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_msgs::srv::HADMapService_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: geom_upper_bound
  {
    ...
    for (size_t i = 0; i < size; i++) {
      cdr << ros_message.geom_upper_bound[i];
    }
  }
  // Member: geom_lower_bound
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      cdr << ros_message.geom_lower_bound[i];
    }
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_msgs::srv::HADMapService_Request & ros_message)
{
  // Member: requested_primitives
  {
    cdr >> ros_message.requested_primitives;
...
{
  auto typed_message =
    static_cast<const autoware_auto_msgs::srv::HADMapService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_msgs::srv::HADMapService_Request *>(
    untyped_ros_message);
...
static size_t _HADMapService_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_HADMapService_Request(full_bounded, 0);
}
...
{
  return &autoware_auto_msgs::srv::typesupport_fastrtps_cpp::_HADMapService_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_msgs, srv, HADMapService_Request)() {
  return &autoware_auto_msgs::srv::typesupport_fastrtps_cpp::_HADMapService_Request__handle;
}
...
{
bool cdr_serialize(
  const autoware_auto_msgs::msg::HADMapBin &,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autoware_auto_msgs
cdr_serialize(
  const autoware_auto_msgs::srv::HADMapService_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: map
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_msgs::srv::HADMapService_Response & ros_message)
{
  // Member: map
  ...
  size_t current_alignment)
{
  ...
  // Member: map
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        autoware_auto_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_HADMapBin(
...
{
  auto typed_message =
    static_cast<const autoware_auto_msgs::srv::HADMapService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autoware_auto_msgs::srv::HADMapService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _HADMapService_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_HADMapService_Response(full_bounded, 0);
}
...
{
  return &autoware_auto_msgs::srv::typesupport_fastrtps_cpp::_HADMapService_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_msgs, srv, HADMapService_Response)() {
  return &autoware_auto_msgs::srv::typesupport_fastrtps_cpp::_HADMapService_Response__handle;
}
...
{
  return &autoware_auto_msgs::srv::typesupport_fastrtps_cpp::_HADMapService__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_msgs, srv, HADMapService)() {
  return &autoware_auto_msgs::srv::typesupport_fastrtps_cpp::_HADMapService__handle;
}
