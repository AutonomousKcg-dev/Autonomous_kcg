...
#include "autoware_auto_msgs/srv/detail/modify_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const autoware_auto_msgs::srv::ModifyTrajectory_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_msgs::srv::ModifyTrajectory_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_ModifyTrajectory_Request(full_bounded, 0);
}
...
{
  return &autoware_auto_msgs::srv::typesupport_fastrtps_cpp::_ModifyTrajectory_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const autoware_auto_msgs::srv::ModifyTrajectory_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autoware_auto_msgs::srv::ModifyTrajectory_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_ModifyTrajectory_Response(full_bounded, 0);
}
...
{
  return &autoware_auto_msgs::srv::typesupport_fastrtps_cpp::_ModifyTrajectory_Response__handle;
}
...
{
  return &autoware_auto_msgs::srv::typesupport_fastrtps_cpp::_ModifyTrajectory__handle;
}
