...
#include "autoware_auto_msgs/msg/detail/diagnostic_header__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_msgs::msg::DiagnosticHeader & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_msgs::msg::DiagnosticHeader & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const autoware_auto_msgs::msg::DiagnosticHeader *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_msgs::msg::DiagnosticHeader *>(
    untyped_ros_message);
...
static size_t _DiagnosticHeader__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_DiagnosticHeader(full_bounded, 0);
}
...
{
  return &autoware_auto_msgs::msg::typesupport_fastrtps_cpp::_DiagnosticHeader__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_msgs, msg, DiagnosticHeader)() {
  return &autoware_auto_msgs::msg::typesupport_fastrtps_cpp::_DiagnosticHeader__handle;
}
