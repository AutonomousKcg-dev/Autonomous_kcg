...
#include "autoware_auto_msgs/msg/detail/vehicle_state_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_msgs::msg::VehicleStateCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_msgs::msg::VehicleStateCommand & ros_message)
{
  // Member: stamp
...
{
  auto typed_message =
    static_cast<const autoware_auto_msgs::msg::VehicleStateCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_msgs::msg::VehicleStateCommand *>(
    untyped_ros_message);
...
static size_t _VehicleStateCommand__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_VehicleStateCommand(full_bounded, 0);
}
...
{
  return &autoware_auto_msgs::msg::typesupport_fastrtps_cpp::_VehicleStateCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_msgs, msg, VehicleStateCommand)() {
  return &autoware_auto_msgs::msg::typesupport_fastrtps_cpp::_VehicleStateCommand__handle;
}
