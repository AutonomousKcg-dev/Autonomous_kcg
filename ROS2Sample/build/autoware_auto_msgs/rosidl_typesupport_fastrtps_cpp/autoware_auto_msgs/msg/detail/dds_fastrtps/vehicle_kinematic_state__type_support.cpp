...
#include "autoware_auto_msgs/msg/detail/vehicle_kinematic_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_auto_msgs::msg::TrajectoryPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const autoware_auto_msgs::msg::VehicleKinematicState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_msgs::msg::VehicleKinematicState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        autoware_auto_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrajectoryPoint(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const autoware_auto_msgs::msg::VehicleKinematicState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_msgs::msg::VehicleKinematicState *>(
    untyped_ros_message);
...
{
  return max_serialized_size_VehicleKinematicState(full_bounded, 0);
}
...
{
  return &autoware_auto_msgs::msg::typesupport_fastrtps_cpp::_VehicleKinematicState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_msgs, msg, VehicleKinematicState)() {
  return &autoware_auto_msgs::msg::typesupport_fastrtps_cpp::_VehicleKinematicState__handle;
}
