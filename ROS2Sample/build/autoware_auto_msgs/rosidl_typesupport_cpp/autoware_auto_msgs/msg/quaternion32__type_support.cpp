...
static const _Quaternion32_type_support_symbol_names_t _Quaternion32_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_msgs, msg, Quaternion32)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_msgs, msg, Quaternion32)),
  }
};
...
{
  return &::autoware_auto_msgs::msg::rosidl_typesupport_cpp::Quaternion32_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_auto_msgs, msg, Quaternion32)() {
  return get_message_type_support_handle<autoware_auto_msgs::msg::Quaternion32>();
}
