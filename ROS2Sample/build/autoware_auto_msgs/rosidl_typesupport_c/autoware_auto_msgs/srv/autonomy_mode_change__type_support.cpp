...
static const _AutonomyModeChange_Request_type_support_symbol_names_t _AutonomyModeChange_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, AutonomyModeChange_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, AutonomyModeChange_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_msgs, srv, AutonomyModeChange_Request)() {
  return &::autoware_auto_msgs::srv::rosidl_typesupport_c::AutonomyModeChange_Request_message_type_support_handle;
}
...
static const _AutonomyModeChange_Response_type_support_symbol_names_t _AutonomyModeChange_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, AutonomyModeChange_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, AutonomyModeChange_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_autoware_auto_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_msgs, srv, AutonomyModeChange_Response)() {
  return &::autoware_auto_msgs::srv::rosidl_typesupport_c::AutonomyModeChange_Response_message_type_support_handle;
}
...
static const _AutonomyModeChange_type_support_symbol_names_t _AutonomyModeChange_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, AutonomyModeChange)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, AutonomyModeChange)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_msgs, srv, AutonomyModeChange)() {
  return &::autoware_auto_msgs::srv::rosidl_typesupport_c::AutonomyModeChange_service_type_support_handle;
}
