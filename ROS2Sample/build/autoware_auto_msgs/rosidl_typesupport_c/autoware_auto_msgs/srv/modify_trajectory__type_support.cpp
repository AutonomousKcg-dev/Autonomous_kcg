...
static const _ModifyTrajectory_Request_type_support_symbol_names_t _ModifyTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, ModifyTrajectory_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, ModifyTrajectory_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_msgs, srv, ModifyTrajectory_Request)() {
  return &::autoware_auto_msgs::srv::rosidl_typesupport_c::ModifyTrajectory_Request_message_type_support_handle;
}
...
static const _ModifyTrajectory_Response_type_support_symbol_names_t _ModifyTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, ModifyTrajectory_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, ModifyTrajectory_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_autoware_auto_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_msgs, srv, ModifyTrajectory_Response)() {
  return &::autoware_auto_msgs::srv::rosidl_typesupport_c::ModifyTrajectory_Response_message_type_support_handle;
}
...
static const _ModifyTrajectory_type_support_symbol_names_t _ModifyTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, ModifyTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, ModifyTrajectory)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_msgs, srv, ModifyTrajectory)() {
  return &::autoware_auto_msgs::srv::rosidl_typesupport_c::ModifyTrajectory_service_type_support_handle;
}
