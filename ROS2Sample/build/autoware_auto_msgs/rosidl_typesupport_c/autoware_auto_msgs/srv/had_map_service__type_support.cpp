...
static const _HADMapService_Request_type_support_symbol_names_t _HADMapService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, HADMapService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, HADMapService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_msgs, srv, HADMapService_Request)() {
  return &::autoware_auto_msgs::srv::rosidl_typesupport_c::HADMapService_Request_message_type_support_handle;
}
...
static const _HADMapService_Response_type_support_symbol_names_t _HADMapService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, HADMapService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, HADMapService_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_autoware_auto_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_msgs, srv, HADMapService_Response)() {
  return &::autoware_auto_msgs::srv::rosidl_typesupport_c::HADMapService_Response_message_type_support_handle;
}
...
static const _HADMapService_type_support_symbol_names_t _HADMapService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_msgs, srv, HADMapService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, HADMapService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_msgs, srv, HADMapService)() {
  return &::autoware_auto_msgs::srv::rosidl_typesupport_c::HADMapService_service_type_support_handle;
}
