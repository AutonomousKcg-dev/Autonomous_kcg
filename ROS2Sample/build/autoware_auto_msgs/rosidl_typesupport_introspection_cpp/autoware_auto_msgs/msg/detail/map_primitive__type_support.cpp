...
{
  new (message_memory) autoware_auto_msgs::msg::MapPrimitive(_init);
}

void MapPrimitive_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_auto_msgs::msg::MapPrimitive *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MapPrimitive_message_member_array[2] = {
  {
    ...
    offsetof(autoware_auto_msgs::msg::MapPrimitive, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs::msg::MapPrimitive, primitive_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MapPrimitive_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_auto_msgs::msg::MapPrimitive),
...
get_message_type_support_handle<autoware_auto_msgs::msg::MapPrimitive>()
{
  return &::autoware_auto_msgs::msg::rosidl_typesupport_introspection_cpp::MapPrimitive_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_msgs, msg, MapPrimitive)() {
  return &::autoware_auto_msgs::msg::rosidl_typesupport_introspection_cpp::MapPrimitive_message_type_support_handle;
}
