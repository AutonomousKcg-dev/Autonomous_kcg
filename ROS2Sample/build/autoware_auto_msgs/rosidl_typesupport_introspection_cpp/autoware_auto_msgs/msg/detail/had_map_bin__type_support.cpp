...
{
  new (message_memory) autoware_auto_msgs::msg::HADMapBin(_init);
}

void HADMapBin_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_auto_msgs::msg::HADMapBin *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HADMapBin_message_member_array[5] = {
  {
    ...
    offsetof(autoware_auto_msgs::msg::HADMapBin, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs::msg::HADMapBin, map_format),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs::msg::HADMapBin, format_version),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs::msg::HADMapBin, map_version),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs::msg::HADMapBin, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HADMapBin_message_members = {
  ...
  5,  // number of fields
  sizeof(autoware_auto_msgs::msg::HADMapBin),
...
{
  return &::autoware_auto_msgs::msg::rosidl_typesupport_introspection_cpp::HADMapBin_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_msgs, msg, HADMapBin)() {
  return &::autoware_auto_msgs::msg::rosidl_typesupport_introspection_cpp::HADMapBin_message_type_support_handle;
}
