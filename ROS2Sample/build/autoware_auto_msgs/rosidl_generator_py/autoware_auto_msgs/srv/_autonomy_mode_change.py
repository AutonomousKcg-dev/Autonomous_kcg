...
class Metaclass_AutonomyModeChange(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'autoware_auto_msgs.srv.AutonomyModeChange')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from autoware_auto_msgs.srv import _autonomy_mode_change
...
class AutonomyModeChange(metaclass=Metaclass_AutonomyModeChange):
    from autoware_auto_msgs.srv._autonomy_mode_change import AutonomyModeChange_Request as Request
    from autoware_auto_msgs.srv._autonomy_mode_change import AutonomyModeChange_Response as Response
