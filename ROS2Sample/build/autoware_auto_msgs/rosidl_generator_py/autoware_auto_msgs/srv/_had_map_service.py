        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'geom_upper_bound' field must be a set or sequence with length <= 3 and each value of type 'float'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'geom_lower_bound' field must be a set or sequence with length <= 3 and each value of type 'float'"
...
class Metaclass_HADMapService_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_auto_msgs.msg import HADMapBin
...
class HADMapService_Response(metaclass=Metaclass_HADMapService_Response):
    ...
    _fields_and_field_types = {
        'map': 'autoware_auto_msgs/HADMapBin',
        'answer': 'int32',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['autoware_auto_msgs', 'msg'], 'HADMapBin'),  # noqa: E501
...
class Metaclass_HADMapService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_auto_msgs.srv import _had_map_service
...
class HADMapService(metaclass=Metaclass_HADMapService):
    from autoware_auto_msgs.srv._had_map_service import HADMapService_Request as Request
    from autoware_auto_msgs.srv._had_map_service import HADMapService_Response as Response
