...
bool autoware_auto_msgs__msg__vehicle_state_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_msgs.msg._vehicle_state_command.VehicleStateCommand", full_classname_dest, 65) == 0);
  }
  autoware_auto_msgs__msg__VehicleStateCommand * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of VehicleStateCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_msgs.msg._vehicle_state_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleStateCommand");
