...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<autoware_auto_msgs/TrajectoryPoint, 200>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['autoware_auto_msgs', 'msg'], 'TrajectoryPoint'), 200),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'points' field must be a set or sequence with length <= 200 and each value of type 'TrajectoryPoint'"
        self._points = value
