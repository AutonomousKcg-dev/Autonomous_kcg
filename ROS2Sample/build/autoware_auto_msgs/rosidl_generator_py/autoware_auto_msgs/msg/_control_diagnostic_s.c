...
bool autoware_auto_msgs__msg__diagnostic_header__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * autoware_auto_msgs__msg__diagnostic_header__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool autoware_auto_msgs__msg__control_diagnostic__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_msgs.msg._control_diagnostic.ControlDiagnostic", full_classname_dest, 60) == 0);
  }
  autoware_auto_msgs__msg__ControlDiagnostic * ros_message = _ros_message;
  {  // diag_header
    PyObject * field = PyObject_GetAttrString(_pymsg, "diag_header");
    if (!field) {
      return false;
    }
    if (!autoware_auto_msgs__msg__diagnostic_header__convert_from_py(field, &ros_message->diag_header)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * autoware_auto_msgs__msg__control_diagnostic__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_msgs.msg._control_diagnostic");
  ...
  {  // diag_header
    PyObject * field = NULL;
    field = autoware_auto_msgs__msg__diagnostic_header__convert_to_py(&ros_message->diag_header);
    if (!field) {
      return NULL;
    }
    {
