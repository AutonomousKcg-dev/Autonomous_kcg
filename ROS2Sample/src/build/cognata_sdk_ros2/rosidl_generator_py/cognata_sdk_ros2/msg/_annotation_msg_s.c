...
bool cognata_sdk_ros2__msg__annotation_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cognata_sdk_ros2.msg._annotation_msg.AnnotationMsg", full_classname_dest, 50) == 0);
  }
  cognata_sdk_ros2__msg__AnnotationMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // local_transform
    ...
    if (!geometry_msgs__msg__transform__convert_from_py(field, &ros_message->local_transform)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of AnnotationMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cognata_sdk_ros2.msg._annotation_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AnnotationMsg");
  ...
  {  // local_transform
    PyObject * field = NULL;
    field = geometry_msgs__msg__transform__convert_to_py(&ros_message->local_transform);
    if (!field) {
      return NULL;
    }
    {
