...
#ifndef AUTOWARE_AUTO_VEHICLE_MSGS__MSG__DETAIL__WHEEL_ENCODER__FUNCTIONS_H_
#define AUTOWARE_AUTO_VEHICLE_MSGS__MSG__DETAIL__WHEEL_ENCODER__FUNCTIONS_H_
 ...
 * calls
 * autoware_auto_vehicle_msgs__msg__WheelEncoder__init().
...
/**
 * It calls
 * autoware_auto_vehicle_msgs__msg__WheelEncoder__fini()
 ...
 * autoware_auto_vehicle_msgs__msg__WheelEncoder__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_auto_vehicle_msgs__msg__WheelEncoder__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_AUTO_VEHICLE_MSGS__MSG__DETAIL__WHEEL_ENCODER__FUNCTIONS_H_
