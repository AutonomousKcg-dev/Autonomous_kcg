...
#include "autoware_auto_vehicle_msgs/msg/detail/wheel_encoder__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_vehicle_msgs::msg::WheelEncoder & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_vehicle_msgs::msg::WheelEncoder & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const autoware_auto_vehicle_msgs::msg::WheelEncoder *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_vehicle_msgs::msg::WheelEncoder *>(
    untyped_ros_message);
...
static size_t _WheelEncoder__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_WheelEncoder(full_bounded, 0);
}
...
get_message_type_support_handle<autoware_auto_vehicle_msgs::msg::WheelEncoder>()
{
  return &autoware_auto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_WheelEncoder__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_vehicle_msgs, msg, WheelEncoder)() {
  return &autoware_auto_vehicle_msgs::msg::typesupport_fastrtps_cpp::_WheelEncoder__handle;
}
