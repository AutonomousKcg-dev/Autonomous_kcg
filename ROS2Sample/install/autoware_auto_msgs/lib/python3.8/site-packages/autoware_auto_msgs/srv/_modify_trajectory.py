...
class ModifyTrajectory_Request(metaclass=Metaclass_ModifyTrajectory_Request):
    ...
    _fields_and_field_types = {
        'original_trajectory': 'autoware_auto_msgs/Trajectory',
    }
...
class ModifyTrajectory_Response(metaclass=Metaclass_ModifyTrajectory_Response):
    ...
    _fields_and_field_types = {
        'modified_trajectory': 'autoware_auto_msgs/Trajectory',
    }
...
class Metaclass_ModifyTrajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'autoware_auto_msgs.srv.ModifyTrajectory')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from autoware_auto_msgs.srv import _modify_trajectory
...
class ModifyTrajectory(metaclass=Metaclass_ModifyTrajectory):
    from autoware_auto_msgs.srv._modify_trajectory import ModifyTrajectory_Request as Request
    from autoware_auto_msgs.srv._modify_trajectory import ModifyTrajectory_Response as Response
