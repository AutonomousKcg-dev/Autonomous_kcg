...
class Metaclass_ControlDiagnostic(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_auto_msgs.msg import DiagnosticHeader
...
class ControlDiagnostic(metaclass=Metaclass_ControlDiagnostic):
    ...
    _fields_and_field_types = {
        'diag_header': 'autoware_auto_msgs/DiagnosticHeader',
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['autoware_auto_msgs', 'msg'], 'DiagnosticHeader'),  # noqa: E501
