...
bool autoware_auto_msgs__msg__had_map_bin__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_msgs.msg._had_map_bin.HADMapBin", full_classname_dest, 45) == 0);
  }
  autoware_auto_msgs__msg__HADMapBin * ros_message = _ros_message;
  {  // header
...
PyObject * autoware_auto_msgs__msg__had_map_bin__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_msgs.msg._had_map_bin");
