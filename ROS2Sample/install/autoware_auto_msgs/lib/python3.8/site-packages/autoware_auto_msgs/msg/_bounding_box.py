...
class Metaclass_BoundingBox(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_auto_msgs.msg import Quaternion32
...
class BoundingBox(metaclass=Metaclass_BoundingBox):
    ...
    _fields_and_field_types = {
        ...
        'orientation': 'autoware_auto_msgs/Quaternion32',
        'velocity': 'float',
        'heading': 'float',
        'heading_rate': 'float',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['geometry_msgs', 'msg'], 'Point32'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['autoware_auto_msgs', 'msg'], 'Quaternion32'),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'variance' field must be a set or sequence with length 8 and each value of type 'float'"
