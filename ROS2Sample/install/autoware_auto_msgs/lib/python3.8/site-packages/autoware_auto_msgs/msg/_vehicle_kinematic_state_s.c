...
bool autoware_auto_msgs__msg__vehicle_kinematic_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_msgs.msg._vehicle_kinematic_state.VehicleKinematicState", full_classname_dest, 69) == 0);
  }
  autoware_auto_msgs__msg__VehicleKinematicState * ros_message = _ros_message;
  {  // header
  ...
  {  // state
    ...
    if (!autoware_auto_msgs__msg__trajectory_point__convert_from_py(field, &ros_message->state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * autoware_auto_msgs__msg__vehicle_kinematic_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_msgs.msg._vehicle_kinematic_state");
  ...
  {  // state
    PyObject * field = NULL;
    field = autoware_auto_msgs__msg__trajectory_point__convert_to_py(&ros_message->state);
    if (!field) {
      return NULL;
    }
    {
