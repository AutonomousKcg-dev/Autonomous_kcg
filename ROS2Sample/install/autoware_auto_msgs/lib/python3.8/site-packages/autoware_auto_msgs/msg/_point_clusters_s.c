...
bool autoware_auto_msgs__msg__point_clusters__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_msgs.msg._point_clusters.PointClusters", full_classname_dest, 52) == 0);
  }
  autoware_auto_msgs__msg__PointClusters * ros_message = _ros_message;
  {  // clusters
...
{
  /* NOTE(esteve): Call constructor of PointClusters */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_msgs.msg._point_clusters");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointClusters");
