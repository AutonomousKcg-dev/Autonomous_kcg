...
bool autoware_auto_msgs__msg__complex32__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_msgs.msg._complex32.Complex32", full_classname_dest, 43) == 0);
  }
  autoware_auto_msgs__msg__Complex32 * ros_message = _ros_message;
  {  // real
...
PyObject * autoware_auto_msgs__msg__complex32__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_msgs.msg._complex32");
