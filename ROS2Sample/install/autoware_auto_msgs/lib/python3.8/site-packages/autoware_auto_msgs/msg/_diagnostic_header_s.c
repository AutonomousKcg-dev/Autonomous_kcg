...
bool autoware_auto_msgs__msg__diagnostic_header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_msgs.msg._diagnostic_header.DiagnosticHeader", full_classname_dest, 58) == 0);
  }
  autoware_auto_msgs__msg__DiagnosticHeader * ros_message = _ros_message;
  {  // name
...
PyObject * autoware_auto_msgs__msg__diagnostic_header__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_msgs.msg._diagnostic_header");
