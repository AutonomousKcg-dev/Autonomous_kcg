...
ROSIDL_GENERATOR_C_IMPORT
PyObject * geometry_msgs__msg__point32__convert_to_py(void * raw_ros_message);
bool autoware_auto_msgs__msg__quaternion32__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool autoware_auto_msgs__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_auto_msgs.msg._bounding_box.BoundingBox", full_classname_dest, 48) == 0);
  }
  autoware_auto_msgs__msg__BoundingBox * ros_message = _ros_message;
  {  // centroid
  ...
  {  // orientation
    ...
    if (!autoware_auto_msgs__msg__quaternion32__convert_from_py(field, &ros_message->orientation)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * autoware_auto_msgs__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_auto_msgs.msg._bounding_box");
  ...
  {  // orientation
    PyObject * field = NULL;
    field = autoware_auto_msgs__msg__quaternion32__convert_to_py(&ros_message->orientation);
    if (!field) {
      return NULL;
    }
    {
