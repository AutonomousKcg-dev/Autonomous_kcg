  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_auto_msgs__srv__HADMapService_Request__init(message_memory);
}

void HADMapService_Request__rosidl_typesupport_introspection_c__HADMapService_Request_fini_function(void * message_memory)
{
  autoware_auto_msgs__srv__HADMapService_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember HADMapService_Request__rosidl_typesupport_introspection_c__HADMapService_Request_message_member_array[3] = {
  {
    ...
    offsetof(autoware_auto_msgs__srv__HADMapService_Request, requested_primitives),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    3,  // array size
    true,  // is upper bound
    offsetof(autoware_auto_msgs__srv__HADMapService_Request, geom_upper_bound),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    true,  // is upper bound
    offsetof(autoware_auto_msgs__srv__HADMapService_Request, geom_lower_bound),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers HADMapService_Request__rosidl_typesupport_introspection_c__HADMapService_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_auto_msgs__srv__HADMapService_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, HADMapService_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  autoware_auto_msgs__srv__HADMapService_Response__init(message_memory);
}
...
{
  autoware_auto_msgs__srv__HADMapService_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember HADMapService_Response__rosidl_typesupport_introspection_c__HADMapService_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs__srv__HADMapService_Response, map),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs__srv__HADMapService_Response, answer),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers HADMapService_Response__rosidl_typesupport_introspection_c__HADMapService_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_auto_msgs__srv__HADMapService_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_autoware_auto_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, HADMapService_Response)() {
  HADMapService_Response__rosidl_typesupport_introspection_c__HADMapService_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, msg, HADMapBin)();
...
static rosidl_typesupport_introspection_c__ServiceMembers autoware_auto_msgs__srv__detail__had_map_service__rosidl_typesupport_introspection_c__HADMapService_service_members = {
  "autoware_auto_msgs__srv",  // service namespace
  "HADMapService",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // autoware_auto_msgs__srv__detail__had_map_service__rosidl_typesupport_introspection_c__HADMapService_Request_message_type_support_handle,
  NULL  // response message
  // autoware_auto_msgs__srv__detail__had_map_service__rosidl_typesupport_introspection_c__HADMapService_Response_message_type_support_handle
};

static rosidl_service_type_support_t autoware_auto_msgs__srv__detail__had_map_service__rosidl_typesupport_introspection_c__HADMapService_service_type_support_handle = {
  0,
  &autoware_auto_msgs__srv__detail__had_map_service__rosidl_typesupport_introspection_c__HADMapService_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, HADMapService)() {
  if (!autoware_auto_msgs__srv__detail__had_map_service__rosidl_typesupport_introspection_c__HADMapService_service_type_support_handle.typesupport_identifier) {
    autoware_auto_msgs__srv__detail__had_map_service__rosidl_typesupport_introspection_c__HADMapService_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)autoware_auto_msgs__srv__detail__had_map_service__rosidl_typesupport_introspection_c__HADMapService_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, HADMapService_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_msgs, srv, HADMapService_Response)()->data;
  }

  return &autoware_auto_msgs__srv__detail__had_map_service__rosidl_typesupport_introspection_c__HADMapService_service_type_support_handle;
}
