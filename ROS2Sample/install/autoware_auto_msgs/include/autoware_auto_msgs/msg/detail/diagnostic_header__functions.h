...
#ifndef AUTOWARE_AUTO_MSGS__MSG__DETAIL__DIAGNOSTIC_HEADER__FUNCTIONS_H_
#define AUTOWARE_AUTO_MSGS__MSG__DETAIL__DIAGNOSTIC_HEADER__FUNCTIONS_H_
 ...
 * calls
 * autoware_auto_msgs__msg__DiagnosticHeader__init().
...
/**
 * It calls
 * autoware_auto_msgs__msg__DiagnosticHeader__fini()
 ...
 * autoware_auto_msgs__msg__DiagnosticHeader__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_auto_msgs__msg__DiagnosticHeader__Sequence__fini()
 * on the array,
...
#endif  // AUTOWARE_AUTO_MSGS__MSG__DETAIL__DIAGNOSTIC_HEADER__FUNCTIONS_H_
