  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  autoware_auto_msgs__msg__HADMapBin__init(message_memory);
}

void HADMapBin__rosidl_typesupport_introspection_c__HADMapBin_fini_function(void * message_memory)
{
  autoware_auto_msgs__msg__HADMapBin__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember HADMapBin__rosidl_typesupport_introspection_c__HADMapBin_message_member_array[5] = {
  {
    ...
    offsetof(autoware_auto_msgs__msg__HADMapBin, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs__msg__HADMapBin, map_format),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs__msg__HADMapBin, format_version),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs__msg__HADMapBin, map_version),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs__msg__HADMapBin, data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers HADMapBin__rosidl_typesupport_introspection_c__HADMapBin_message_members = {
  ...
  5,  // number of fields
  sizeof(autoware_auto_msgs__msg__HADMapBin),
