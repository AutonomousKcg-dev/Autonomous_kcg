...
{
  new (message_memory) autoware_auto_msgs::msg::Route(_init);
}

void Route_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_auto_msgs::msg::Route *>(message_memory);
  typed_message->~Route();
}

size_t size_function__Route__primitives(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<autoware_auto_msgs::msg::MapPrimitive> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<autoware_auto_msgs::msg::MapPrimitive> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<autoware_auto_msgs::msg::MapPrimitive> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Route_message_member_array[4] = {
  {
    ...
    offsetof(autoware_auto_msgs::msg::Route, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs::msg::Route, start_point),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_msgs::msg::Route, goal_point),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<autoware_auto_msgs::msg::MapPrimitive>(),  // members of sub message
    true,  // is array
    100,  // array size
    true,  // is upper bound
    offsetof(autoware_auto_msgs::msg::Route, primitives),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<autoware_auto_msgs::msg::Route>()
{
  return &::autoware_auto_msgs::msg::rosidl_typesupport_introspection_cpp::Route_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_msgs, msg, Route)() {
  return &::autoware_auto_msgs::msg::rosidl_typesupport_introspection_cpp::Route_message_type_support_handle;
}
