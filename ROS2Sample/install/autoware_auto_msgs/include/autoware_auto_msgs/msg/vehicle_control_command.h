...
#ifndef AUTOWARE_AUTO_MSGS__MSG__VEHICLE_CONTROL_COMMAND_H_
#define AUTOWARE_AUTO_MSGS__MSG__VEHICLE_CONTROL_COMMAND_H_
...
#endif  // AUTOWARE_AUTO_MSGS__MSG__VEHICLE_CONTROL_COMMAND_H_
