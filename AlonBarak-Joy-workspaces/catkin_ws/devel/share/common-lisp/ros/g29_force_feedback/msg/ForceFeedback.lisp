...
(cl:defmethod position-val ((m <ForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_force_feedback-msg:position-val is deprecated.  Use g29_force_feedback-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'torque-val :lambda-list '(m))
(cl:defmethod torque-val ((m <ForceFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader g29_force_feedback-msg:torque-val is deprecated.  Use g29_force_feedback-msg:torque instead.")
  (torque m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ForceFeedback>)))
  ...
  "e090eb9eec6a6e3a1658541a33681145")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ForceFeedback)))
  "Returns md5sum for a message object of type 'ForceFeedback"
  "e090eb9eec6a6e3a1658541a33681145")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ForceFeedback>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%float32 position~%float32 torque~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ForceFeedback)))
  "Returns full string definition for message of type 'ForceFeedback"
  (cl:format cl:nil "std_msgs/Header header~%float32 position~%float32 torque~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
